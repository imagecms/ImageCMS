...
//        $I->waitForElementNotVisible("alert.in.fade.alert-success");
    ...
    public function CreateCallbackWithoutThemes(CallbacksTester $I)
    {
        ...
        $nameThemeList=$I->grabAttributeFrom(CallbacksPage::ThemeSelListLandingLine('1').'/..', "selected");
        ...
        $nameThemeEdit=$I->grabAttributeFrom(CallbacksPage::$ThemeSelEdit, "selected");
