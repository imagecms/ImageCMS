...
class LocUaPage
{
    ...
    public static $CityField = ".//*[@id='register-form']/div/div[2]/div[2]/label[3]/input";
    ...
    public static $RusLangRegisterFormLink = "/html/body/div[1]/header/div/ul[1]/li[1]";
    public static $UkrLangRegisterFormLink = "/html/body/div[1]/header/div/ul[1]/li[2]";
    ...
    public static $ExitButton = "/html/body/div[1]/header/div/ul/li[1]/ul/li[2]/a";
    public static $RusLangProfileButton = "/html/body/div[1]/header/div/div[2]/div/ul/li[1]";
    public static $UkrLangProfileButton = "/html/body/div[1]/header/div/div[2]/div/ul/li[2]";
}