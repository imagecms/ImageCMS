...
//        $I->seeInField('', DiscountsPage::$UntilDateCreate);
    ...
    /**
     * @guy DiscountsTester\DiscountsSteps
     */
    
    public function OneSymbolsInCreate(DiscountsTester\DiscountsSteps $I)
    {
        $name='a';
        $amount='1';
        $type='2';
        $value='2';        
        $begin='6';
        $I->CreateDiscount($name, $amount, $method= 'procent',$value, $type,$begin);
//        $I->amOnPage("/admin/components/init_window/mod_discount/create");        
