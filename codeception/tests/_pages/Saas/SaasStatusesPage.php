...
class SaasStatusesPage

{

    public static $ListURL = '/admin/components/cp/saas/users_statuses';
    ...
    public static function LineDescription($row)          { return "//section/div[2]/div/div/table/tbody/tr[$row]/td[4]/p"; }
    ...
    public static $CreateInputDescription = '//section/form/div/table/tbody/tr/td/div/div/div[2]/div/textarea';
