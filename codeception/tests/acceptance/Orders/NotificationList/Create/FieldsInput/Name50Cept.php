...
$I->fillField('//span[2]/input', 'аааааааааааааааааааааааааааааааааааааааааааааааааа');
$I->click('//span[2]/div/button'); 
$I->amOnPage('/admin/components/run/shop/notifications');
$I->click(['link' => 'ad@min.com']);
$I->seeInField('//div[2]/div/div/input', 'аааааааааааааааааааааааааааааааааааааааааааааааааа');
$I->amOnPage('/admin/components/run/shop/notifications');
