...
$I->fillField(NotificationStatusesPage::$CreationFildInput, 'QWE фыв !@# 123 ЪХЗ zxc');
...
$I->fillField(NotificationStatusesPage::$EditingFildInput, 'Бяка');
...
$I->waitForElement('//div[4]/form/table/tbody/tr/td[3]/a');       
$I->click(['link' => 'ad@min.com']);
$I->dontSee('QWE фыв !@# 123 ЪХЗ zxc');
$I->see('Бяка', '//select');
