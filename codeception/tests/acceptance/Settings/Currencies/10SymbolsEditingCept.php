...
$I->fillField('.//*[@id="cur_ed_form"]/table/tbody/tr/td/div/div[1]/div/input', 'qййййй1234');
$I->fillField('.//*[@id="cur_ed_form"]/table/tbody/tr/td/div/div[2]/div/input', 'qййййй1234');
$I->fillField('.//*[@id="cur_ed_form"]/table/tbody/tr/td/div/div[3]/div/input', 'qййййй1234');
$I->fillField('.//*[@id="mod_name"]/div/input', '105236.2354');
...
$I->seeInField('.//*[@id="mod_name"]/div/input', '105236.2354');      
