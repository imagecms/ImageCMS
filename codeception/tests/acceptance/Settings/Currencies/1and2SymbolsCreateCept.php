...
$I->fillField('.//*[@id="cur_cr_form"]/table/tbody/tr/td/div/div[1]/div/input', 'q');
$I->fillField('.//*[@id="cur_cr_form"]/table/tbody/tr/td/div/div[2]/div/input', 'q');
$I->fillField('.//*[@id="cur_cr_form"]/table/tbody/tr/td/div/div[3]/div/input', 'q');
...
$I->appendField('.//*[@id="cur_cr_form"]/table/tbody/tr/td/div/div[1]/div/input', 'q');
$I->click('.//*[@id="mainContent"]/section/div[1]/div[2]/div/button[1]');
