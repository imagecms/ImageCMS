...
class ProductsPage
{
   //URL of products list page
    ...
    //Buttons in Editing
    public static $PropertyButton  = '//*[@id="image_upload_form"]/div[1]/div[1]/a[2]'; //Свойства
    public static $ImagesButton  = '//*[@id="image_upload_form"]/div[1]/div[1]/a[3]'; //Дополнительные фотографии
    public static $KitsProductButton  = '//*[@id="image_upload_form"]/div[1]/div[1]/a[4]'; //Наборы
    public static $AccessoriesButton  = '//*[@id="image_upload_form"]/div[1]/div[1]/a[5]'; //Аксессуары
    public static $PrefButtonEditing  = '//*[@id="image_upload_form"]/div[1]/div[1]/a[6]'; //Настройки
