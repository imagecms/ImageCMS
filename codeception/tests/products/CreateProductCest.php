...
class CreateProductCest
{
    ...
    public function NamesInCreate(ProductsTester $I)
    {
        ...
        $I->waitForElement('//*[@id="parameters"]/div/div[1]/div[4]/div/div');
        ...
        $I->see('Название товара:', "//*[@id='parameters']/div/div[1]/div[1]/div[1]/label");
        $I->see('*', "//*[@id='parameters']/div/div[1]/div[1]/div[1]/label/span");
        $I->see('Старая цена:', '//*[@id="parameters"]/div/div[1]/div[3]/label');
        $I->see('Статус:', "//*[@id='parameters']/div/div[1]/div[2]/label");
        $I->see('Товар:', '//*[@id="parameters"]/div/div[1]/div[4]/label');
        $I->see('Название варианта товара', "//*[@id='parameters']/div/div[1]/div[4]/div/div/table/thead/tr/th[2]");
        $I->see('Цена', '//*[@id="parameters"]/div/div[1]/div[4]/div/div/table/thead/tr/th[3]');
        $I->see('*', '//*[@id="parameters"]/div/div[1]/div[4]/div/div/table/thead/tr/th[3]/span');
        $I->see('Валюта', '//*[@id="parameters"]/div/div[1]/div[4]/div/div/table/thead/tr/th[4]');
        ...
        $I->see('Артикул', '//*[@id="parameters"]/div/div[1]/div[4]/div/div/table/thead/tr/th[5]');
        $I->see('Количество', '//*[@id="parameters"]/div/div[1]/div[4]/div/div/table/thead/tr/th[6]');
//        $I->see('Фото', '//*[@id="parameters"]/div/div[1]/div[4]/div/div/table/thead/tr/th[1]');
        $I->see('Добавить вариант', ProductsPage::$AddVariantButton);
        $I->see('Название бренда:', '//*[@id="parameters"]/div/div[2]/div/div[1]/label');
        ...
        $I->click(ProductsPage::$BrandName);
        $I->see('Категория:', '//*[@id="parameters"]/div/div[2]/div/div[2]/label');
        ...
        $I->click(ProductsPage::$Category);
        $I->see('Дополнительные категории:', '//*[@id="parameters"]/div/div[2]/div/div[3]/label');
        ...
        $I->click(ProductsPage::$AdditionalCategory);
        $I->see('Краткое описание:', '//*[@id="parameters"]/div/div[3]/label');
        $I->see('Полное описание:', '//*[@id="parameters"]/div/div[4]/label');
...
//        $I->waitForText('Список валют');
    ...
    public function RequiredFieldsSaveButtonInCreate(ProductsTester $I)
    {
        ...
        $I->see('Это поле обязательное.', '//*[@id="parameters"]/div/div[1]/div[1]/div[1]/div/label');
...
//        $amount='1';
//        $brand='Не указано';
//        $addCat1='Выберите категории';
////        $comment='Нет';
////        $comment='Да';
//        $I->CheckInFields($name, $nameVariant=null, $price, null,null,null,$currency=null, $articul=null, $amount,$image2=null, $brand, 
//                $category=null, null, $shortDesc=null, $fullDesc=null, $comment='yes', $ret["date"]);
//        $I->see($addCat1, \ProductsPage::$AdditionalCategory.'/ul/li/input');
//        $I->click(ProductsPage::$GoBackButton);
//        $I->CheckInListLanding($name, $category=null, $articul=null, $price, $this->MAINSYM);
//        $I->CheckInFrontEnd($name, $category=null, $articul=null, $price, $this->MAINSYM, null,null,null,null,$comment='yes');
//    }
    ...
    public function CreateProduct2(ProductsTester\ProductsSteps $I)
    {
        ...
        $I->CheckInFrontEnd($name, $text[2], $articul, $price, $this->MAINSYM, $ret["brand"], $im2, $shortDesc=null, $fullDesc=null, $comment, $oldPrice);
    }
...
//        $I->CheckInFrontEnd($name, $text[6], $articul, $price2, $this->MAINSYM, $ret["brand"], $shortDesc, $fullDesc, $comment='no', $oldPrice=null,$url);
//    }
