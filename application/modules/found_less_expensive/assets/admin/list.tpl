                   ...
                   <table class="table table-striped table-bordered table-hover table-condensed">
                    <thead>
                        <tr>
                            ...
                            <th class="span5">Ссилка на товар</th>
                            ...
                            <tr data-id="{echo $d['id']}">
                                ...
                                <td> 
                                    <select class="statusSelect" data-id="">
                                        <option {if $d['status'] == '0'}selected{/if} data-status="countNew" data-statusNumber="0">Новий</option>
                                        <option {if $d['status'] == '1'}selected{/if} data-status="countAccepted" data-statusNumber="1">Обработаний</option>
                                    </select>
                                </td>
