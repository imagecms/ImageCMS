            ...
            <div class="row-fluid">
                <div>
                    <div class="pull-right frame_zH_frame_title">
                        <span class="help-inline"></span>
                        <div class="d-i_b">
                            <a href="/admin/components/cp/cfcm/create_field" class="btn btn-small btn-success" ><i class=" icon-plus-sign icon-white m-r_5"></i>{lang('Add field', 'cfcm')}</a>
                        </div>
                    </div>
                    {/*}
                    ...
                    <table class="table  table-bordered table-hover table-condensed pages-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="/admin/components/cp/cfcm/edit_field/{$f.field_name}" data-rel="tooltip" data-title="{lang("Edit custom field", 'cfcm')}">{$f.label}</a>
                                </td>
                                <td>{$f.field_name}</td>
                                <td>{$f.type}</td>
                                <td>
            ...
            <div class="row-fluid">
                <div>
                    <div class="pull-right frame_zH_frame_title">
                        <span class="help-inline"></span>
                        <div class="d-i_b">
                            <a href="/admin/components/cp/cfcm/create_group" class="btn btn-small btn-success" ><i class=" icon-plus-sign icon-white m-r_5"></i>{lang('Create group', 'cfcm')}</a>
                        </div>
                    ...
                    <table class="table  table-bordered table-hover table-condensed pages-table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>{$g.id}</td>
                                <td>
                                    <a data-rel="tooltip" data-title="{lang("Edit custom group", 'cfcm')}" href="/admin/components/cp/cfcm/edit_group/{$g.id}" >{$g.name}</a>
                                </td>
