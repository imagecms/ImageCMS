    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            ...
            <div class="d-i_b">
                ...
                <button type="button" class="btn btn-small action_on formSubmit btn-success"  data-action="edit" data-form="#{echo $f_id = uniqid()}"><i class="icon-ok icon-white"></i>{if $CI->uri->segment(5) == 'create_field'}{lang("Create", 'admin')}{else:}{lang("Save", 'cfcm')}{/if}</button>
