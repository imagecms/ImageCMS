                    ...
                    <td>
                        <div class="inside_padd span10">
                            ...
                            <div class="control-group">
                                ...
                                <div class="controls">
                                    <button type="button" class="btn btn-small btn-default formSubmit" data-form="#sitemap_priorities_form" data-action="show_sitemap" data-submit><i class="icon-share"></i>{lang("Save and view", 'sitemap')}</button>
                                </div>
                            </div>
                        </div>
                    </td>
