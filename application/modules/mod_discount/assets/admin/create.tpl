                                            ...
                                            <div id="categoryBlock" class="forHide" style="display: none;">
                                                ...
                                                <span class="frame_label" >
                                                    <span class="niceCheck">
                                                        <input type="checkbox" name="category[child]" value="1"/>
                                                    </span>
                                ...
                                <div class="">
                                    ...
                                    <div class="span8">
                                        <div class="">
                                            <span class="d-i_b">
                                                <label class="p_r">
                                                    <input class="required discountDate beginDateDiscount" value="{date("Y-m-d", time())}" required="required" type="text" value="" name="date_begin" onkeypress="return false;" onkeyup="return false;" onkeydown="return false;" autocomplete="off" />
