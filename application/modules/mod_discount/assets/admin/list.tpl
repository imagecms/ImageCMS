                ...
                <tbody>
                    {foreach $discountsList as $discount}
                        <tr data-id="{echo $discount['id']}">
                            <td>
                                <a data-rel="tooltip" data-title="{lang("Edit discount", 'mod_discount')}" href="/admin/components/init_window/mod_discount/edit/{echo $discount['id']}" >{echo $discount['key']}</a>
                            </td>
                            <td>
