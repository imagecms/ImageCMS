...
$com_info = [
             'menu_name'   => lang('Автоматическое создание артикула', 'mod_auto_number'), // Menu name
             'description' => lang('Модуль автоматического заполнения артикула товара при его создании', 'mod_auto_number'), // Module Description
