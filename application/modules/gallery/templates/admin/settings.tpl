<section class="mini-layout">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <button name="button" class="btn formSubmit" data-submit data-form="#gallery_settings_form">{lang('amt_save')}</button> 
            </div>
        </div>
    </div>
        ...
        <div class="form-horizontal row-fluid">
            <div class="span7">
                <form method="post" action="{site_url('admin/components/cp/gallery/settings/update')}" id="gallery_settings_form">
                    <h3>{lang('amt_albums_and_categories')}</h3>
