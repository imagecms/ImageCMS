                        ...
                        <td colspan="6">
                            <div class="inside_padd">
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type = "text" name = "settings[from]" class="textbox_short required" value="{$settings['from']}" id="from"/>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type = "text" name = "settings[from_email]" class="textbox_short required" value="{$settings['from_email']}" id="from_email"/>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type = "text" name = "settings[admin_email]" class="textbox_short required" value="{$settings['admin_email']}" id="admin_email"/>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    ...
                                    <div class="controls">
                                        <input type = "text" name = "settings[theme]" class="textbox_short required" value="{$settings['theme']}" id="theme"/>
                                    </div>
                                </div>
                                ...
                                <div class="control-group wraperControlGroup" {if !$settings['wraper_activ']} style="display: none" {/if}>
                                    ...
                                    <div class="controls">
                                        <textarea name='settings[wraper]' class="elRTE required"  id="wraper">{$settings['wraper']}</textarea>
                                    </div>
                                </div>
