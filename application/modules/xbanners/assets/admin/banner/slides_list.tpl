                            ...
                            <div class="controls photo_album photo_album-v">
                                ...
                                <div class="btn-group f-s_0" style="display: none">
                                    <button type="button" class="btn change_image btn-small" data-rel="tooltip" data-title="{lang('Edit','xbanners')}" data-original-title=""><i class="icon-edit"></i></button>
                                        {if !$image->getSrc()}
                                        <button type="button" class="btn delete_image btn-small" data-rel="tooltip" data-title="{lang('Delete','xbanners')}"><i class="icon-trash"></i></button>
                                        {/if}   
                                        {if $image->getSrc()}
                                ...
                                <div class="photo-block {if $image->getSrc()}isImage{/if}">
                                    ...
                                    {/if}
                                    <span class='fon-size' style="display:none;">{echo $banner->getWidth()}x{echo $banner->getHeight()} {echo lang('px', 'xbanners')}</span>
                                </div>
                                    ...
                                    {if $image->getActive()}
                                        ...
                                        {else:}
                                            ...
                                            {if $image->getActiveFrom()}
                                                {lang('from', 'xbanners')}
                                                {echo date('Y-m-d', $image->getActiveFrom())}
                                            {/if}

                                            {if $image->getActiveTo()}
                                                {lang('to', 'xbanners')}
                                                {echo date('Y-m-d', $image->getActiveTo())}
                                            {/if}
                                        {/if}
                                    {else:}
                                ...
                                <div class="controls hide-control">
                                    <label class="v-a_m" style="width:115px;margin-right:10px; display: inline-block;margin-bottom:0px;">
                                        <span class="o_h d_b p_r">
                                            <input type="text" data-placement="top" data-original-title="{lang('choose a date','admin')}" data-rel="tooltip" class="datepicker " name="image[active_from]" value="{if $image->getActiveFrom()}{echo date('Y-m-d', $image->getActiveFrom())}{/if}" placeholder="{lang('from','admin')}">
                                            <i class="icon-calendar"></i>
                                        </span>
                                    </label>
                                    <label class="v-a_m" style="width:115px; display: inline-block;margin-bottom:0px;">
                                        <span class="o_h d_b p_r">
                                            <input type="text" data-placement="top" data-original-title="{lang('choose a date','admin')}" data-rel="tooltip" class="datepicker " name="image[active_to]" value="{if $image->getActiveTo()}{echo date('Y-m-d', $image->getActiveTo())}{/if}" placeholder="{lang('to','admin')}">
                                            <i class="icon-calendar"></i>
                                        </span>
                                    </label>
                                </div>
