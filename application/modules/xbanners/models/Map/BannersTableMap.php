...
class BannersTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'xbanners.models.Map.BannersTableMap';
     ...
     */
    const OM_CLASS = '\\xbanners\\models\\Banners';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'xbanners.models.Banners';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\xbanners\\models\\Banners');
    ...
    {
        $this->addRelation('BannerImage', '\\xbanners\\models\\BannerImage', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':banner_id',
    1 => ':id',
        ...
        $this->addRelation('BannersI18n', '\\xbanners\\models\\BannersI18n', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \xbanners\models\Banners) { // it's a model object
