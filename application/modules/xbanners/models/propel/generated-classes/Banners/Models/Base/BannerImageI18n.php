...
abstract class BannerImageI18n implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Banners\\Models\\Map\\BannerImageI18nTableMap';
    ...
    /**
     * Initializes internal state of Banners\Models\Base\BannerImageI18n object.
     * @see applyDefaults()
     */
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Banners\Models\BannerImageI18n
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Banners\Models\BannerImageI18n The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Banners\Models\BannerImageI18n (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Banners\Models\BannerImageI18n Clone of current object.
     * @throws PropelException
     */
