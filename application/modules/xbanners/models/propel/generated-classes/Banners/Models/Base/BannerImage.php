...
abstract class BannerImage implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Banners\\Models\\Map\\BannerImageTableMap';
    ...
    /**
     * Initializes internal state of Banners\Models\Base\BannerImage object.
     */
     ...
     * @return $this|\Banners\Models\BannerImage The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Banners\\Models\\BannerImage'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->bannerImageI18nsScheduledForDeletion !== null) {
                if (!$this->bannerImageI18nsScheduledForDeletion->isEmpty()) {
                    \Banners\Models\BannerImageI18nQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Banners\Models\BannerImage
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Banners\Models\BannerImage The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Banners\Models\BannerImage (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Banners\Models\BannerImage Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBannerImageI18ns($overrideExisting = true)
    {
        ...
        $this->collBannerImageI18ns = new ObjectCollection();
        $this->collBannerImageI18ns->setModel('\Banners\Models\BannerImageI18n');
    }
