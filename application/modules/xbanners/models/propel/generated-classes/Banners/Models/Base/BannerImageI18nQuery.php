...
use \Exception;
use \PDO;
use Banners\Models\BannerImageI18n as ChildBannerImageI18n;
use Banners\Models\BannerImageI18nQuery as ChildBannerImageI18nQuery;
 ...
 *
 * @method     \Banners\Models\BannerImageQuery endUse() Finalizes a secondary criteria and merges it with its primary Criteria
 *
...
abstract class BannerImageI18nQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Banners\Models\Base\BannerImageI18nQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'Shop', $modelName = '\\Banners\\Models\\BannerImageI18n', $modelAlias = null)
    {
    ...
    public function findPk($key, ConnectionInterface $con = null)
    {
        ...
        if ((null !== ($obj = BannerImageI18nTableMap::getInstanceFromPool(serialize(array((string) $key[0], (string) $key[1]))))) && !$this->formatter) {
    ...
    protected function findPkSimple($key, ConnectionInterface $con)
    {
        ...
        if ($row = $stmt->fetch(\PDO::FETCH_NUM)) {
            ...
            $obj->hydrate($row);
            BannerImageI18nTableMap::addInstanceToPool($obj, serialize(array((string) $key[0], (string) $key[1])));
        }
        $stmt->closeCursor();
     ...
     *
     * @param \Banners\Models\BannerImage|ObjectCollection $bannerImage The related object(s) to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @throws \Propel\Runtime\Exception\PropelException
     *
