...
class BannerImageI18nTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Banners.Models.Map.BannerImageI18nTableMap';
     ...
     */
    const OM_CLASS = '\\Banners\\Models\\BannerImageI18n';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Banners.Models.BannerImageI18n';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Banners\\Models\\BannerImageI18n');
    ...
    {
        $this->addRelation('BannerImage', '\\Banners\\Models\\BannerImage', RelationMap::MANY_TO_ONE, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
     ...
     * and findPk*() calls.
     *
     * @param \Banners\Models\BannerImageI18n $obj A \Banners\Models\BannerImageI18n object.
     ...
     *
     * @param mixed $value A \Banners\Models\BannerImageI18n object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Banners\Models\BannerImageI18n) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Banners\Models\BannerImageI18n object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Banners\Models\BannerImageI18n) { // it's a model object
