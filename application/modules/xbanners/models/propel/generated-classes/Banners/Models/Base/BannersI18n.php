...
abstract class BannersI18n implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Banners\\Models\\Map\\BannersI18nTableMap';
    ...
    /**
     * Initializes internal state of Banners\Models\Base\BannersI18n object.
     * @see applyDefaults()
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Banners\\Models\\BannersI18n'), 0, $e);
        }
    }
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Banners\Models\BannersI18n
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Banners\Models\BannersI18n The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Banners\Models\BannersI18n (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Banners\Models\BannersI18n Clone of current object.
     * @throws PropelException
     */
