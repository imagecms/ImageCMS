...
abstract class BannerImageQuery extends ModelCriteria
{
    ...
    /**
     * Initializes internal state of \Banners\Models\Base\BannerImageQuery object.
     *
     * @param     string $dbName The database name
     * @param     string $modelName The phpName of a model, e.g. 'Book'
     * @param     string $modelAlias The alias for the model in this query, e.g. 'b'
     */
    public function __construct($dbName = 'Shop', $modelName = '\\Banners\\Models\\BannerImage', $modelAlias = null)
    {
    ...
    /**
     * Filter the query by a related \Banners\Models\BannerImageI18n object
     *
     * @param \Banners\Models\BannerImageI18n|ObjectCollection $bannerImageI18n the related object to use as filter
     * @param string $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return ChildBannerImageQuery The current query, for fluid interface
     */
    ...
    {
        if ($bannerImageI18n instanceof \Banners\Models\BannerImageI18n) {
            return $this
            ...
            throw new PropelException('filterByBannerImageI18n() only accepts arguments of type \Banners\Models\BannerImageI18n or Collection');
        }
    }
     ...
     * @param     string $joinType Accepted values are null, 'left join', 'right join', 'inner join'
     *
     * @return \Banners\Models\BannerImageI18nQuery A secondary query class using the current class as primary query
     */
    public function useBannerImageI18nQuery($relationAlias = null, $joinType = 'LEFT JOIN')
    {
        return $this
            ->joinBannerImageI18n($relationAlias, $joinType)
            ->useQuery($relationAlias ? $relationAlias : 'BannerImageI18n', '\Banners\Models\BannerImageI18nQuery');
    }
    ...
    protected function doOnDeleteCascade(ConnectionInterface $con)
    {
        ...
        foreach ($objects as $obj) {
            ...
            $query = new \Banners\Models\BannerImageI18nQuery;
