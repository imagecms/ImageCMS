...
class BannerImageTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = 'Banners.Models.Map.BannerImageTableMap';
     ...
     */
    const OM_CLASS = '\\Banners\\Models\\BannerImage';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'Banners.Models.BannerImage';
    ...
    public function initialize()
    {
        ...
        $this->setClassName('\\Banners\\Models\\BannerImage');
  ...
  array (
    ...
    1 => ':id',
        ...
        $this->addRelation('BannerImageI18n', '\\Banners\\Models\\BannerImageI18n', RelationMap::ONE_TO_MANY, array (
  0 =>
  array (
    0 => ':id',
    1 => ':id',
    ...
    {
        return array(
            'i18n' => array('i18n_table' => '%TABLE%_i18n', 'i18n_phpname' => '%PHPNAME%I18n', 'i18n_columns' => 'src, name, clicks', 'i18n_pk_column' => '', 'locale_column' => 'locale', 'locale_length' => '5', 'default_locale' => 'ru', 'locale_alias' => '', ),
        );
    } // getBehaviors()
    /**
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Banners\Models\BannerImage) { // it's a model object
