...
use \Exception;
use \PDO;
use Banners\Models\BannerImage as ChildBannerImage;
use Banners\Models\BannerImageQuery as ChildBannerImageQuery;
 ...
 *
 *
* @package    propel.generator.Banners.Models.Base
*/
abstract class Banners implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Banners\\Models\\Map\\BannersTableMap';
    ...
    /**
     * Initializes internal state of Banners\Models\Base\Banners object.
     */
     ...
     * @return $this|\Banners\Models\Banners The current object (for fluent API support)
     */
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            throw new PropelException(sprintf('Error populating %s object', '\\Banners\\Models\\Banners'), 0, $e);
        }
    }
        ...
        if (!$this->alreadyInSave) {
            ...
            if ($this->bannerImagesScheduledForDeletion !== null) {
                if (!$this->bannerImagesScheduledForDeletion->isEmpty()) {
                    \Banners\Models\BannerImageQuery::create()
            ...
            if ($this->bannersI18nsScheduledForDeletion !== null) {
                if (!$this->bannersI18nsScheduledForDeletion->isEmpty()) {
                    \Banners\Models\BannersI18nQuery::create()
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\Banners\Models\Banners
     */
     ...
     * @param string $keyType The type of keys the array uses.
     *
     * @return $this|\Banners\Models\Banners The current object, for fluid interface
     */
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Banners\Models\Banners (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Banners\Models\Banners Clone of current object.
     * @throws PropelException
     */
    ...
    public function initBannerImages($overrideExisting = true)
    {
        ...
        $this->collBannerImages = new ObjectCollection();
        $this->collBannerImages->setModel('\Banners\Models\BannerImage');
    }
    ...
    public function initBannersI18ns($overrideExisting = true)
    {
        ...
        $this->collBannersI18ns = new ObjectCollection();
        $this->collBannersI18ns->setModel('\Banners\Models\BannersI18n');
    }
    ...
    public function getCurrentTranslation(ConnectionInterface $con = null)
    {
         ...
         *
         * @param string $v new value
         * @return $this|\Banners\Models\BannersI18n The current object (for fluent API support)
         */
