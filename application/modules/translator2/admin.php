...
//        var_dumps(extension_loaded('curl'));
    ...
    public function index() {
        ...
        if ($translation) {
            ...
            if('" . $type . "'!='main') document.getElementById('modules_templates').style.display = 'inline-block';
            if('" . $type . "'!='main') document.getElementById('modules_templates').innerHTML = '" . $names . "';
