<section class="mini-layout">
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                <a href="{$BASE_URL}admin/components/cp/sample_mail" class="t-d_n m-r_15 pjax"><span class="f-s_14">←</span> <span class="t-d_u">{lang("Go back", 'admin')}</span></a>
                <button type="button" class="btn btn-small btn-primary formSubmit" data-form="#widget_form"><i class="icon-ok"></i>{lang("Save", 'admin')}</button>
    ...
    <form action="{$BASE_URL}admin/components/cp/sample_mail/edit/{$model.name}/{$locale}" id="widget_form" method="post" class="form-horizontal m-t_10">
