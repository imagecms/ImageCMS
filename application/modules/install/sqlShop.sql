...
INSERT INTO `shop_discounts` (`id`, `name`, `active`, `date_start`, `date_stop`, `discount`, `min_price`, `max_price`, `categories`, `products`, `description`) VALUES
(4, 'Скидка на Видео технику', 1, 1293829200, 1296507600, '10%', 0.00, 0.00, 'a:3:{i:0;s:2:"37";i:1;s:2:"38";i:2;s:2:"39";}', '', '<p>Скидка на Видео технику в размере 10%</p>');
...
INSERT INTO `shop_orders` (`id`, `key`, `delivery_method`, `delivery_price`, `status`, `paid`, `user_full_name`, `user_email`, `user_phone`, `user_deliver_to`, `user_comment`, `date_created`, `date_updated`, `user_ip`) VALUES
(22, '31l72739ic', 5, 0.00, 0, 0, 'tester', 'tester@tester.ccom', '', '', '', 1294744684, 1294744684, '127.0.0.3');
...
(26, 22, 74, 85, 'Samsung LN40C650 40" LCD TV', '', 899.99, 1);
...
('1e08538c9b444d67d57aec6fb2d584f2', 1, 'Mozilla/5.0 (X11; U; Linux i686; en-US) AppleWebKit/534.7 (KHTML, like Gecko) Chrome/7.0.517.44 Safari/534.7', '127.0.0.2', '2010-11-19 12:11:59'),
('c622061ad82075b57a18e881f42d6ff4', 1, 'Mozilla/5.0 (X11; U; Linux i686; en-US) AppleWebKit/534.7 (KHTML, like Gecko) Chrome/7.0.517.44 Safari/534.7', '127.0.0.8', '2010-11-17 15:17:06'),
('2085ba50a519db35fdba69296af165f9', 1, 'Mozilla/5.0 (X11; U; Linux i686; en-US) AppleWebKit/534.10 (KHTML, like Gecko) Chrome/8.0.552.224 Safari/534.10', '127.0.0.2', '2010-12-27 12:43:23');
