...
(56, 0, 0, 'Услуги', '', '<p>Помимо разработки и продажи роботов различных конфигураций, наша компания предоставляет также полный спектр услуг связанных с работоспособностью роботов. Со всем списком Вы можете ознакомиться ниже.</p>', 'usluhi', '', '', '', 'b:0;', '', '', '', 15, 'position', 'asc', 0, 7, 11, 'a:2:{s:26:"category_apply_for_subcats";b:0;s:17:"apply_for_subcats";b:0;}'),
...
(67, 'core', 47, 'admin', 'ad@min.com', '', 65, 'gfdg', 1373360688, 0, 'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/28.0.1500.71 Safari/537.36', '127.0.0.1', 0, '', '', 0, 0, 0);
...
('field_11', 'text', 'йцукен', 'a:6:{s:10:"field_name";s:2:"11";s:5:"label";s:12:"йцукен";s:9:"in_search";s:1:"1";s:4:"type";s:4:"text";s:6:"groups";a:1:{i:0;s:2:"11";}s:4:"data";s:0:"";}', 2, 1);
...
(2, 84, 'a:1:{i:0;a:1:{s:7:"role_id";s:1:"0";}}');
...
(92, 47, 'admin', 'Очистил кеш', 1369235710),
(93, 47, 'admin', 'Создал язык eng', 1369235790),
(94, 47, 'admin', 'Очистил кеш', 1369997418),
(95, 47, 'admin', 'Очистил кеш', 1369997438),
(96, 47, 'admin', 'Вошел в панель управления IP 127.0.0.1', 1369997903),
(97, 47, 'admin', 'Вышел из панели управления', 1369998411),
(98, 47, 'admin', 'Вошел в панель управления IP 127.0.0.1', 1369998418),
(99, 47, 'admin', 'Забанил пользователя <a href="http://www.t1.loc/admin/components/cp/user_manager/edit_user/10">Юрий</a>', 1370000492),
(100, 47, 'admin', 'Разбанил пользователя <a href="http://www.t1.loc/admin/components/cp/user_manager/edit_user/10">Юрий</a>', 1370000493),
(101, 47, 'admin', 'Забанил пользователя <a href="http://www.t1.loc/admin/components/cp/user_manager/edit_user/11">Артур</a>', 1370000496),
(102, 47, 'admin', 'Разбанил пользователя <a href="http://www.t1.loc/admin/components/cp/user_manager/edit_user/11">Артур</a>', 1370000510),
(103, 47, 'admin', 'Очистил кеш', 1370001301),
(104, 47, 'admin', 'Изменил страницу<a href="http://www.t1.loc/admin/pages/edit/84">MY_Controller::getCurrentLocale()</a>', 1370001617),
(105, 47, 'admin', 'Изменил настройки сайта', 1370600694),
(106, 47, 'admin', 'Очистил кеш', 1370600705),
(107, 47, 'admin', 'Вошел в панель управления IP 127.0.0.1', 1370609731),
(108, 47, 'admin', 'Очистил кеш', 1370609739),
(109, 47, 'admin', 'Вошел в панель управления IP 127.0.0.1', 1370884003),
(110, 47, 'admin', 'Изменил страницу<a href="http://www.t1.loc/admin/pages/edit/66">Космические роботы</a>', 1370884037),
(111, 47, 'admin', 'Изменил страницу<a href="http://www.t1.loc/admin/pages/edit/66">Космические роботы</a>', 1370884048),
(112, 47, 'admin', 'Изменил страницу<a href="http://www.t1.loc/admin/pages/edit/66">Космические роботы</a>', 1370884368),
(113, 47, 'admin', 'Вошел в панель управления IP 127.0.0.1', 1370936313),
(114, 47, 'admin', 'Очистил кеш', 1372940581),
(115, 47, 'admin', 'Изменил настройки сайта', 1372940595),
(116, 47, 'admin', 'Очистил кеш', 1372944419),
(117, 47, 'admin', 'Изменил категорию   <a href="/admin/categories/edit/56"> Услуги5</a>', 1372944532),
(118, 47, 'admin', 'Изменил категорию   <a href="/admin/categories/edit/56"> Услуги</a>', 1372944625),
(119, 47, 'admin', 'Создал виджет 56456', 1372944818),
(120, 47, 'admin', 'Удалил виджет 56456', 1372944827),
(121, 47, 'admin', 'Изменил категорию   <a href="/admin/categories/edit/56"> Услуги</a>', 1372944921),
(122, 47, 'admin', 'Очистил кеш', 1373360196),
(123, 47, 'admin', 'Изменил страницу<a href="http://www.t1.loc/admin/pages/edit/65">Боевые роботы</a>', 1373360217),
(124, 47, 'admin', 'Изменил страницу<a href="http://www.t1.loc/admin/pages/edit/65">Боевые роботы</a>', 1373360397),
(125, 47, 'admin', 'Изменил страницу<a href="http://www.t1.loc/admin/pages/edit/65">Боевые роботы</a>', 1373360469),
(126, 47, 'admin', 'Изменил страницу<a href="http://www.t1.loc/admin/pages/edit/65">Боевые роботы</a>', 1373360970);
...
(1, 'main_menu', 'Главное меню', 'main_menu', 1, 'Главное меню шаблона', '2012-11-12 21:57:53'),
(4, 'bottom_menu', 'Нижнее меню', '', 0, 'Нижнее меню шаблона', '2010-12-07 13:56:59');
...
(2, 1, 59, 'category', '', '', 0, 'Блог', 0, 10, NULL, 'a:1:{s:7:"newpage";s:1:"0";}'),
...
(10, 1, 56, 'category', '', '', 0, 'Услуги', 0, 6, NULL, 'N;'),
(11, 1, 57, 'category', '', '', 0, 'Новости', 0, 8, NULL, NULL),
(12, 1, 58, 'category', '', '', 0, 'Вакансии', 0, 9, NULL, NULL),
