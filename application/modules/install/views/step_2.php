...
<form action="" method="post">
    ...
    <div class="form_input">
        ...
        <?php
        if ($this->form_validation->error('site_title')) { echo '<div class="alert alert-error errors_list">' . $this->form_validation->error('site_title') . '</div>';
...
?>
    ...
    <div class="form_input">
        ...
        <span style="color: red;">*</span>
<?php
if ($this->form_validation->error('db_user')) { echo '<div class="alert alert-error errors_list">' . $this->form_validation->error('db_user') . '</div>';
...
?>
    ...
    <div class="form_input">
        ...
        <span style="color: red;">*</span>
<?php
if ($this->form_validation->error('db_name')) { echo '<div class="alert alert-error errors_list">' . $this->form_validation->error('db_name') . '</div>';
...
?>
    ...
    <div class="form_input">
        ...
        <span style="color: red;">*</span>
<?php
if ($this->form_validation->error('admin_mail')) { echo '<div class="alert alert-error errors_list">' . $this->form_validation->error('admin_mail') . '</div>';
...
?>
    ...
    <div class="form_input">
        ...
        <span style="color: red;">*</span>
<?php
if ($this->form_validation->error('admin_pass')) { echo '<div class="alert alert-error errors_list">' . $this->form_validation->error('admin_pass') . '</div>';
