...
-->
	...
	<div class="form_text" style="width:150px;">{lang("Group")}:</div>
	...
	<div class="form_input">
		<input type="submit" class="button" value="{lang("Save")}" onclick="ajax_me('edit_perms_form');" />
        <a href="#" onclick="check_all(); return false;">Отметить все</a>  /  <a href="#" onclick="uncheck_all(); return false;">{lang("unmark or deselect")}</a>
	</div>
	<div class="form_overflow"></div>
