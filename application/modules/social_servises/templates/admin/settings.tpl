    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <button type="button" class="btn btn-small btn-success formSubmit" data-form="#social_servises"><i class="icon-list-alt icon-white"></i>{lang('a_save')}</button>
            </div>
        </div>                            
    </div>
                                    ...
                                    <div class="inside_padd">
                                        <div class="row-fluid">
                                            <div class="control-group">
                                                <label class="control-label" for="foncheck">{lang('a_facebook_on')}:</label>
                                                <div class="controls">
                            ...
                            <tr>
                                <td colspan="6">
                                    <div class="inside_padd">
                                        <div class="row-fluid">
                                            <div class="control-group">
                                                <label class="control-label" for="foncheck">{lang('a_vk_on')}:</label>
                                                <div class="controls">
                                                    <span class="frame_label">
                                                        <span class="niceCheck b_n">
