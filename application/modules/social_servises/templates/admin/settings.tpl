<section class="mini-layout">
    <div class="frame_title clearfix">
        <div class="pull-left">
            ...
            <span class="title">{lang("Integration with social servises module settings")}</span>
        </div>
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <button type="button" class="btn btn-small btn-primary formSubmit" data-form="#social_servises" data-submit><i class="icon-ok icon-white"></i>{lang("Have been saved")}</button>
            </div>
        </div>                            
    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <span class="frame_label">
                                                ...
                                                {lang("Switch on integration with Facebook?")}
                                            </span>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="secretkey">{lang("Secret key")}:</label>
                                        <div class="controls">
                                            <input type="text" value="{echo $settings.secretkey}" name="facebook[secretkey]" id="secretkey"/> 
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="appnumber">{lang("Application number")}:</label>
                                        <div class="controls">
                                            <input type="text" value="{echo $settings.appnumber}" name="facebook[appnumber]" id="appnumber"/> 
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="seltpl">{lang("Select template folder")}:</label>
                                        <div class="controls">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <span class="frame_label">
                                                ...
                                                {lang("Switch on integration with VKontakte?")}
                                            </span>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="protkey">{lang("Protection key")}:</label>
                                        <div class="controls">
                                            <input type="text" value="{echo $vsettings.protkey}" name="vk[protkey]" id="protkey"/> 
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="vappnumber">{lang("Application number")}:</label>
                                        <div class="controls">
                                            <input type="text" value="{echo $vsettings.appnumber}" name="vk[appnumber]" id="vappnumber"/> 
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        <label class="control-label" for="vseltpl">{lang("Select template folder")}:</label>
                                        <div class="controls">
