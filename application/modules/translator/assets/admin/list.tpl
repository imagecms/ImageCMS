            ...
            <div class="d-i_b">
                ...
                <span class="btn-group" style="display: inline-block;">
                    ...
                    <ul class="dropdown-menu" role="menu" style="left:auto;right: 0px;">
                        <li><a style="text-decoration: none" href="/admin/components/init_window/translator/createFile">{lang('Create translation file', 'translator')}</a></li>
                        <li><a style="text-decoration: none" href="/admin/components/init_window/translator/exchangeTranslation">{lang('Translation exchange', 'translator')}</a></li>
                        ...
                        <li class="divider"></li>
                        <li><a style="text-decoration: none" href="/admin/components/init_window/translator/settings">{lang('Settings', 'translator')}</a></li>
                        <li class="divider"></li>
