...
<div>
    <form id="image_upload_form" style="width:100%;" method="post" enctype="multipart/form-data" action="{site_url('admin/components/run/imagebox/upload')}">
        <div class="form_text">{lang("Select a file")}:</div>
        <div class="form_input"><input type="file" name="userfile[]" id="file" size="30" /></div>
        <div class="form_overflow"></div>

        <div class="form_text">{lang("Or specify URL")}</div>
        ...
        <div class="form_input">
            ...
            <input type="button" value="{lang("Cancel")}"  class="button_silver_130" onclick="MochaUI.closeWindow($('imagebox_module_main_w')); return false;" />
        </div>
        <div class="form_overflow"></div>
...
<div>
    <form style="width:100%;" id="imagebox_settings_form" method="post" action="{site_url('admin/components/run/imagebox/save_settings')}">
        ...
        <div class="form_text"></div>
        <div class="form_input">
            <input type="submit" name="action" value="{lang("Save")}" class="button_silver_130"  onclick="ajax_me('imagebox_settings_form');" />
        </div>
        <div class="form_overflow"></div>
    {form_csrf()}</form>
</div>
