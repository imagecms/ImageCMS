    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <button type="button" class="btn btn-small btn-primary formSubmit" data-form="#widget_form" data-submit><i class="icon-ok"></i>{lang("Have been saved")}</button>
                    ...
                    <td>
                        <div class="inside_padd span9">
                            <div class="control-group">
                                <label class="control-label" for="comcount">{lang("Pages")}:</label>
                                <div class="controls">
                                    <select name="display" id="comcount">
                                        <option value="recent"  {if $widget.settings.display == 'recent'} selected="selected" {/if} >{lang("Latest")}</option>
                                        <option value="popular" {if $widget.settings.display == 'popular'} selected="selected" {/if}>{lang("Popular")}</option>
                                    </select>
                                </div>
                            </div>
                            <div class="control-group">
                            ...
                            <div class="control-group">
                                <label class="control-label" for="newscount">{lang("Number of news for display")}:</label>
                                <div class="controls">
                                    <input type="text" name="news_count" value="{$widget.settings.news_count}" id="newscount"/> 
                                </div>            
                            </div>
                            <div class="control-group">
                                <label class="control-label" for="maxsym">{lang("Maximum number of characters")}:</label>
                                <div class="controls">
