                                            ...
                                            $.ajax(
                                                {
                                                    ...
                                                    .done(
                                                        function (a) {
                                                            ...
                                                            if (a === "login incorrect" || a === "exist") {
                                                                $("#loginResult").text('Внимание! Выбранный Вами логин уже занят. Подберите другое имя.');
                                                            }
                                                            if (a === "email incorrect") {
                                                                $("#emailResult").text('Указанной Вами почты не существует. Исправьте адрес электронной почты и попробуйте еще раз.');
                                                            }
                                                            if (a === 'success') {
