<section class="mini-layout">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                <a href="{$BASE_URL}admin/components/modules_table" class="t-d_n m-r_15 pjax"><span class="f-s_14">←</span> <span class="t-d_u">Вернуться</span></a>
                <button type="button" class="btn btn-small btn-success formSubmit" data-form="#rss_settings_form"><i class="icon-list-alt icon-white"></i>Сохранить</button>
            </div>
        </div>                            
    </div>
