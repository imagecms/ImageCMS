<section class="mini-layout">
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                <a href="/admin/components/cp/menu/menu_item/{$menu.name}" class="t-d_n m-r_15 pjax"><span
                            class="f-s_14"></span>← <span class="t-d_u">{lang("Go back", 'menu')}</span></a>
                <button type="button" class="btn btn-small btn-primary formSubmit submit_link"
                        data-form="#{$item.item_type}_form" data-submit><i class="icon-ok"></i>{lang("Save", "menu")}
                </button>
                <button type="button" class="btn btn-small formSubmit submit_link" data-form="#{$item.item_type}_form"
                        data-action="tomain"><i class="icon-check"></i>{lang("Save and exit", "menu")}</button>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="span5">
            <ul class="btn-group myTab m-t_10 nav-tabs horiz link_type">
                <li class="btn btn-small {if $item.item_type == 'page'} active{/if}"><a
                            href="#page">{lang("Page", "menu")}</a></li>
                <li class="btn btn-small {if $item.item_type == 'category'}active{/if}"><a
                            href="#category">{lang("Categories", "menu")}</a></li>
                <li class="btn btn-small {if $item.item_type == 'module'}active{/if}"><a
                            href="#module">{lang("Module", "menu")}</a></li>
                <li class="btn btn-small {if $item.item_type == 'url'}active{/if}"><a
                            href="#url">{lang("Link", "menu")}</a></li>
            </ul>
        </div>
    </div>
                                                ...
                                                <ul class="nav myTab nav-tabs nav-stacked">
                                                    {foreach $pages.pages_list as $p}
                                                        <li {if $item.item_id == $p.id}class="active"{/if}>
                                                            <a class="page_title" data-url="{$p.cat_url}/{$p.url}"
                                                               href="#" data-title="{$p.title}"
                                                               data-id="{$p.id}">{echo $p.title}</a>
                                                        </li>
                                                    {/foreach}
                                                </ul>
                                            </div>
                        ...
                        <td colspan="6">
                            <div class="inside_padd">
                                <div class="span12">
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">{lang("ID", "menu")}: <span
                                    ...
                                    <div class="control-group">
                                        <label class="control-label">{lang("Title", "menu")}: <span
                                                    class="must">*</span></label>
                                        ...
                                        <div class="controls">
                                            <select name="page_parent_id" id="item_parent_id">
                                                ...
                                                {foreach $parents as $par}
                                                    <option value="{$par.id}"
                                                            {if $item.parent_id != 0 AND $item.parent_id == $par.id}selected="selected"{/if}>
                                                        - {$par.title}</option>
                                                {/foreach}
                                            </select>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="group_icon pull-right">
                                                    <a href="{echo site_url('application/third_party/filemanager/dialog.php?type=1&field_id=Img0');}"
                                            ...
                                            <div class="o_h">
                                                <input type="text" name="page_item_image" id="Img0"
                                            ...
                                            <select id="item_roles" name="item_roles[]" multiple="multiple">
                                                ...
                                                {foreach $roles as $role}
                                                    <option value="{$role.id}"
                                                            {if in_array($role.id, $r)}selected="selected"{/if}>{$role.alt_name}</option>
                                                {/foreach}
                                            </select>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                        ...
                                        <input type="radio" name="page_hidden" value="1"
                                               {if $item.hidden == 1}checked="checked"{/if}/>
                                        </span> {lang("Yes", "menu")}
                                        </span>
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="page_hidden" value="0"
                                               {if $item.hidden == 0}checked="checked"{/if}/>
                                        </span>
                                            {lang("No", "menu")}
                                        </span>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <input type="radio" name="page_newpage" value="1"
                                               {if $data.newpage == 1}checked="checked"{/if}/>
                                        </span> {lang("Yes", "menu")}
                                        </span>
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="page_newpage" value="0"
                                               {if $data.newpage == 0}checked="checked"{/if}/>
                                        </span> {lang("No", "menu")}
                                        </span>
                                        </div>
                                    </div>
                            ...
                            <div class="inside_padd">
                                <div class="span12">
                                        ...
                                        <div class="controls">
                                            <select name="cat_parent_id" id="item_parent_id">
                                                ...
                                                {foreach $parents as $p}
                                                    <option value="{$p.id}"
                                                            {if $item.parent_id != 0 AND $item.parent_id == $p.id}selected="selected"{/if}>
                                                        - {$p.title}</option>
                                                {/foreach}
                                            </select>
                                        </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="group_icon pull-right">
                                                    <a href="{echo site_url('application/third_party/filemanager/dialog.php?type=1&field_id=Img1');}"
                                                       class="btn  iframe-btn" type="button">
                                                        <i class="icon-picture"></i>
                                                        {lang('Choose an image ', "menu")}
                                                    </a>
                                            ...
                                            <div class="o_h">
                                                <input type="text" name="cat_item_image" id="Img1"
                                                       value="{$item.item_image}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="cat_hidden" value="0"
                                               {if $item.hidden == 0}checked="checked"{/if}/>
                                        </span>
                                            {lang("No", "menu")}
                                        </span>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="cat_newpage" value="0"
                                               {if $data.newpage == 0}checked="checked"{/if}/>
                                        </span>
                                            {lang("No", "menu")}
                                        </span>
                    ...
                    <div class="span3">
                        ...
                        <ul class="nav myTab nav-tabs nav-stacked">
                            {foreach $modules as $module}
                                <li><a href="#" class="module_item" onclick="loadPathImg('{$module.name}')"
                                       data-mname="{$module.name}" data-murl="{$module.url_image}"
                                       id="module_{$module.name}" title="{$module.description}">{$module.menu_name}</a>
                                </li>
                            {/foreach}
                        </ul>
                    </div>
                                    ...
                                    <div class="inside_padd">
                                        ...
                                        {lang("Module", "menu")}
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls ctext">
                                                    <span id="module_name_holder"
                                                          class="help-block">{$data.mod_name}</span>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                <label class="control-label">{lang("Title", "menu")}: <span
                                            ...
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="group_icon pull-right">
                                                            <a href="{echo site_url('application/third_party/filemanager/dialog.php?type=1&field_id=Img2');}"
                                                               class="btn  iframe-btn" type="button">
                                                                <i class="icon-picture"></i>
                                                                {lang('Choose an image ', "menu")}
                                                            </a>
                                                    ...
                                                    <div class="o_h">
                                                        <input type="text" name="module_item_image" id="Img2"
                                                               value="{$item.item_image}">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <select id="item_roles" name="item_roles[]" multiple="multiple">
                                                        ...
                                                        {foreach $roles as $role}
                                                            <option value="{$role.id}"
                                                                    {if in_array($role.id, $r)}selected="selected"
                                                                    le{/if}>{$role.alt_name}</option>
                                                        {/foreach}
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="module_hidden" value="1"
                                               {if $item.hidden == 1}checked="checked"{/if}/>
                                        </span>
                                        </span>
                                            {lang("Yes", "menu")}
                                        ...
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="module_hidden" value="0"
                                               {if $item.hidden == 0}checked="checked"{/if}/>
                                        </span>
                                            {lang("No", "menu")}
                                        </span>
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">{lang("Open in the new window", "menu")}
                                                    :</label>
                                        ...
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="module_newpage" value="1"
                                               {if $data.newpage == 1}checked="checked"{/if}/>
                                        </span>
                                            {lang("Yes", "menu")}
                                        </span>
                                        ...
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="module_newpage" value="0"
                                               {if $data.newpage == 0}checked="checked"{/if}/>
                                        </span>
                                            {lang("No", "menu")}
                                        </span>
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="inside_padd">
                                <div class="span12">
                                    <div class="control-group">
                                        <label class="control-label">{lang("Specify or select a link to the page", "menu")}
                                            : <span class="must">*</span></label>

                                        <div class="controls">
                                            <input type="text" id="url_to_page" value="{echo $data.url}"
                                                   name="item_url"/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="inside_padd">
                                <div class="span12">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            <div class="group_icon pull-right">
                                                    <a href="{echo site_url('application/third_party/filemanager/dialog.php?type=1&field_id=Img3');}"
                                                       class="btn  iframe-btn" type="button">
                                                        <i class="icon-picture"></i>
                                                        {lang('Choose an image ', "menu")}
                                                    </a>
                                            ...
                                            <div class="o_h">
                                                <input type="text" name="url_item_image" id="Img3"
                                                       value="{$item.item_image}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="url_hidden" value="1"
                                               {if $item.hidden == 1}checked="checked"{/if}/>
                                        </span>
                                            {lang("Yes", "menu")}
                                        </span>
                                        ...
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="url_hidden" value="0"
                                               {if $item.hidden == 0}checked="checked"{/if}/>
                                        </span>
                                            {lang("No", "menu")}
                                        </span>
                                    ...
                                    <div class="control-group">
                                        ...
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="url_newpage" value="1"
                                               {if $data.newpage == 1}checked="checked"{/if}/>
                                        </span>
                                            {lang("Yes", "menu")}
                                        </span>
                                        ...
                                        <span class="frame_label no_connection">
                                        <span class="niceRadio">
                                        <input type="radio" name="url_newpage" value="0"
                                               {if $data.newpage == 0}checked="checked"{/if}/>
                                        </span>
                                            {lang("No", "menu")}
                                        </span>
