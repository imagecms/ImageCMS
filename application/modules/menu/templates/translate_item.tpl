...
<div class="form_input">
    <input type="submit" name="button" class="button" value="{lang('amt_save')}" onclick="ajax_me('item_t_save_form');" />
    <input type="button" name="button" class="button" value="{lang('amt_cancel')}" onclick="MochaUI.closeWindow($('translate_m_Window'));" />
<div class="form_overflow"></div>
</div>
