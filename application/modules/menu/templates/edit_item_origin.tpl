                                ...
                                <div class="inside_padd">
                                    <div class="span12">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <span class="frame_label no_connection m-r_15">
                                                    <span class="niceRadio"><input type="radio" name="hidden" value="1" {if $item.hidden == 1}checked="checked"{/if}/></span> {lang("Yes")}
                                                </span>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <span class="m-r_15 frame_label no_connection"><span class="niceRadio"><input type="radio" name="newpage" value="1" {if $data.newpage == 1}checked="checked"{/if}/></span> {lang("Yes")}</span>
                                                <span class="frame_label no_connection"><span class="niceRadio"><input type="radio" name="newpage" value="0" {if $data.newpage == 0}checked="checked"{/if}/></span> {lang("No")}</span>
                                            </div>
                                        </div>    
                                    </div>
                                </div>
