    ...
    <div class="frame_title clearfix">
        ...
        <div class="pull-right">
            <div class="d-i_b">
                ...
                <button type="button" class="btn btn-small btn-primary formSubmit submit_link" data-form="#page_form" data-submit><i class="icon-ok"></i>{lang("Have been saved")}</button>
                <button type="button" class="btn btn-small formSubmit submit_link" data-form="#page_form" data-action="tomain"><i class="icon-ok"></i>{lang("Save and go back")}</button>
            </div>
        </div>                            
    </div>
    <div class="row">
        ...
        <div class="span5">
            <ul class="btn-group myTab m-t_10 nav-tabs horiz link_type">
                <li class="btn btn-small active"><a href="#page">{lang("Page")}</a></li>
                <li class="btn btn-small"><a href="#category">{lang("Categories")}</a></li>
                <li class="btn btn-small"><a href="#module">{lang("Module")}</a></li>
                <li class="btn btn-small"><a href="#url">{lang("Link")}</a></li>
            </ul>
        </div>
    </div>
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="group_icon pull-right">            
                                                    <button class="btn btn-small" onclick="elFinderPopup('image', 'Img0');return false;"><i class="icon-picture"></i>  {lang('Choose an image ')}</button>
                                                </div>
                                                <div class="o_h">		            
                                ...
                                <div class="inside_padd">
                                    <div class="span12">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="group_icon pull-right">            
                                                    <button class="btn btn-small" onclick="elFinderPopup('image', 'Img1');return false;"><i class="icon-picture"></i>  {lang('Choose an image ')}</button>
                                                </div>
                                                <div class="o_h">		            
                                        ...
                                        <div class="inside_padd">
                                            <div class="span12">
                                                ...
                                                <div class="control-group">
                                                    ...
                                                    <div class="controls">
                                                        <div class="group_icon pull-right">            
                                                            <button class="btn btn-small" onclick="elFinderPopup('image', 'Img2');return false;"><i class="icon-picture"></i>  {lang('Choose an image ')}</button>
                                                        </div>
                                                        <div class="o_h">		            
                                ...
                                <div class="inside_padd">
                                    <div class="span12">
                                        ...
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <div class="group_icon pull-right">            
                                                    <button class="btn btn-small" onclick="elFinderPopup('image', 'Img3');return false;"><i class="icon-picture"></i>  {lang('Choose an image ')}</button>
                                                </div>
                                                <div class="o_h">		            
