<div style="border:0px;font-size:13px;">
        <table width="100%" border="0" cellpadding="2" cellspacing="2">
               ...
               <td valign="top">
                   ...
                   <input type="hidden" id="owner_id" value="{$insert_id}" /> 
                    ...
                    <div class="field_input">
                        ...
                        <img width="16" height="16" align="absmiddle" src="{$THEME}/images/images.png" title="{lang("Select an image")}" style="cursor: pointer;" onclick="tinyBrowserPopUp('image', 'mod_image');" />
                    </div>                    
		    ...
		    <div class="field_text">
                    ...
                    <div class="field_input">
                        <input type="button" value="{lang("Create")}" id="mod_btn" class="button" onclick="insert_module(); return false;" />
