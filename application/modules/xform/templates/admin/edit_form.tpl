...
<form method="post" action="{site_url('admin/components/cp/xform/edit_form')}/{$form.id}" id="edit_form" style="width:100%;">        
		...
		<div class="form_input">
            <input type="text" class="textbox_long" name="page_url" id="page_url" value="{$form.url}" />
		...
		<div class="form_input">
        <textarea name="desc" id="desc" class="mceEditor">{$form.desc}</textarea>
        </div>
        <div class="form_overflow"></div> 
        
        <div class="form_text">Сообщение об успешном отправлении</div>
		<div class="form_input">
        <textarea name="good" id="good">{$form.seccuss}</textarea><br />
		...
		<div class="form_input">
            <input type="submit" name="button"  class="button_130" value="Сохранить" onclick="ajax_me('edit_form');" />
