...
abstract class BaseSPropertiesPeer {
	...
	private static $fieldNames = array (
		BasePeer::TYPE_PHPNAME => array ('Id', 'Name', 'Active', 'ShowInCompare', 'Position', 'Data', ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'name', 'active', 'showInCompare', 'position', 'data', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NAME, self::ACTIVE, self::SHOW_IN_COMPARE, self::POSITION, self::DATA, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NAME', 'ACTIVE', 'SHOW_IN_COMPARE', 'POSITION', 'DATA', ),
		BasePeer::TYPE_FIELDNAME => array ('id', 'name', 'active', 'show_in_compare', 'position', 'data', ),
	...
	private static $fieldKeys = array (
		BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'Name' => 1, 'Active' => 2, 'ShowInCompare' => 3, 'Position' => 4, 'Data' => 5, ),
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'name' => 1, 'active' => 2, 'showInCompare' => 3, 'position' => 4, 'data' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NAME => 1, self::ACTIVE => 2, self::SHOW_IN_COMPARE => 3, self::POSITION => 4, self::DATA => 5, ),
		BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NAME' => 1, 'ACTIVE' => 2, 'SHOW_IN_COMPARE' => 3, 'POSITION' => 4, 'DATA' => 5, ),
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'name' => 1, 'active' => 2, 'show_in_compare' => 3, 'position' => 4, 'data' => 5, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, 5, )
	);
