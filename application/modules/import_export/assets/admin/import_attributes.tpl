            ...
            <div class="input-append span7 dropup">
                <div class="btn-group pull-right">
                    {if $attrInRow = $attributes[$row]}
                        <div class="btn btn-mini" title="{echo $attrInRow}" style="max-width: 320px;margin-left: 5px; cursor: default;">
                            <span data-attrnames="{echo $row}" class="attrnameHolder">{echo $attrInRow}</span>
                        </div>
                    {else:}
