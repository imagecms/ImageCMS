...
/**
 * Base class that represents a row from the 'page_link_product' table.
 *
 *
 *
 * @package    propel.generator.mod_link.models.Base
 */
abstract class PageLinkProduct extends PropelBaseModelClass implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\mod_link\\models\\Map\\PageLinkProductTableMap';
    ...
    /**
     * Initializes internal state of mod_link\models\Base\PageLinkProduct object.
     */
    ...
    /**
     * Compares this with another <code>PageLinkProduct</code> instance.  If
     * <code>obj</code> is an instance of <code>PageLinkProduct</code>, delegates to
     * <code>equals(PageLinkProduct)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PageLinkProduct The current object, for fluid interface
     */
    ...
    public function setLinkId($v)
    {
        ...
        if ($this->link_id !== $v) {
            $this->link_id = $v;
            $this->modifiedColumns[PageLinkProductTableMap::COL_LINK_ID] = true;
        }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPageLinkProductQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PageLinkProductTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PageLinkProductTableMap::COL_LINK_ID)) {
            $modifiedColumns[':p' . $index++]  = 'link_id';
        }
        if ($this->isColumnModified(PageLinkProductTableMap::COL_PRODUCT_ID)) {
            $modifiedColumns[':p' . $index++]  = 'product_id';
        }

        $sql = sprintf(
            'INSERT INTO page_link_product (%s) VALUES (%s)',
    ...
    {
        $pos = PageLinkProductTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        if (isset($alreadyDumpedObjects['PageLinkProduct'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PageLinkProduct'][$this->hashCode()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(PageLinkProductTableMap::COL_LINK_ID)) {
            $criteria->add(PageLinkProductTableMap::COL_LINK_ID, $this->link_id);
        }
        if ($this->isColumnModified(PageLinkProductTableMap::COL_PRODUCT_ID)) {
            $criteria->add(PageLinkProductTableMap::COL_PRODUCT_ID, $this->product_id);
        }
    ...
    {
        $criteria = ChildPageLinkProductQuery::create();
        $criteria->add(PageLinkProductTableMap::COL_LINK_ID, $this->link_id);
        $criteria->add(PageLinkProductTableMap::COL_PRODUCT_ID, $this->product_id);
    ...
    public function hashCode()
    {
        ...
        //relation page_link_product_fk_5a23ad to table page_link
     ...
     * objects.
     *
     * @param      object $copyObj An object of \mod_link\models\PageLinkProduct (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \mod_link\models\PageLinkProduct Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PageLinkProductTableMap::DEFAULT_STRING_FORMAT);
    }
