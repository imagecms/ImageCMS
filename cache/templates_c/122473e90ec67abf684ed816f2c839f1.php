        ...
        <td colspan="6">
            <div class="foot_cleaner">
                ...
                <div class="f_r">
                            ...
                            <?php endif; ?>
                            <?php if($total <  $item['delivery_free_from']): ?><span class="d_b">(+<?php echo  $item['delivery_price']  ?> <?php if(isset($CS)){ echo $CS; } ?>)</span><?php endif; ?>
                            <span id="dpholder" data-dp="<?php echo  $item['delivery_price']  ?>"></span>
                            <?php if(isset( $item['gift_cert_price'] )): ?><span class="d_b">(-<?php echo  $item['gift_cert_price']  ?> <?php if(isset($CS)){ echo $CS; } ?>)</span><?php endif; ?>
                            <span id="allpriceholder" data-summary="<?php echo $total?>"></span>
                </div>
            </div>
            <div class="f_r sum"><?php echo lang ('s_summ'); ?>:
            </div>
        </div>
</td>
</tr>
...
<?php endif; ?><?php $mabilis_ttl=1357399251; $mabilis_last_modified=1355848993; ///var/www/imagecms.loc/templates/commerce/shop/default/cart_products.tpl ?>