        ...
        <div class="main_body">
            ...
            <?php if($CI->dx_auth->is_logged_in()): ?>
                <div class="frame_nav" id="mainAdminMenu">
                    ...
                    <?php if(SHOP_INSTALLED): ?>
                        <div style="display:none;" class="container" id="shopAdminMenu"  > <?php $this->include_tpl('shop_menu.tpl', '/var/www/sportek.loc/templates/administrator'); ?> </div>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
            <div id="loading"></div>
...
</html><?php $mabilis_ttl=1357819563; $mabilis_last_modified=1357732160; ///var/www/sportek.loc//templates/administrator/main.tpl ?>