...
<html>
        ...
        <div class="main_body">
            <div class="top">
                <div class="center">
                    ...
                    <ul class="user_menu m-l_19 auth_data"><?php $this->include_tpl('auth_data', 'C:\wamp\www\imagecms.loc\templates\commerce\shop\default'); ?></ul>
                    <ul class="user_menu cart_data_holder">                        
                        ...
                        <?php $this->include_tpl('cart_data', 'C:\wamp\www\imagecms.loc\templates\commerce\shop\default'); ?></ul>
                </div>
            </div><!-- top -->
 ...
 if(is_true_array($result)){ foreach ($result as $currency){ ?>
                    ...
                    <li id="wishListHolder" class="like blue<?php if(ShopCore::app()->SWishList->totalItems()): ?> is_avail<?php endif; ?>">
                        <?php $this->include_tpl('wish_list_data', 'C:\wamp\www\imagecms.loc\templates\commerce\shop\default'); ?></li>
                    <!--    Wish list item's for Header    -->
                    ...
                    <li id="compareHolder" class="compare blue<?php if($CI->session->userdata('shopForCompare') && count($CI->session->userdata('shopForCompare'))): ?> is_avail<?php endif; ?>">
                        <?php $this->include_tpl('compare_data', 'C:\wamp\www\imagecms.loc\templates\commerce\shop\default'); ?></li>
                    <!--    Products in compare list for Header    -->
                </ul>
            </div><!-- header -->
