                ...
                <li class="span5 clearfix">
                    ...
                    <a rel="group" id="photoGroup" href="{$model->firstVariant->getMainPhoto()}" class="photo">
                        <figure >
                            ...
                            <img id="imageGroup" src="{$model->firstVariant->getMainPhoto()}" alt="{echo ShopCore::encode($model->getName())} - {echo $model->getId()}" />
                        </figure>                        
                    </a>              
                        ...
                        <div class="d_i-b v-a_b m-b_20">
                            ...
                            {if count($model->getProductVariants()) > 1}
                                ...
                                {foreach $model->getProductVariants() as $key => $pv}
                                    ...
                                    {else:}
                                        {$mainImage = productImageUrl($model->getMainimage())}
                                    {/if}
