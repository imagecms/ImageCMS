...
<div class="comments" id="comments">
    {if $can_comment == 0 OR $is_logged_in}
        <div class="title-comment">{lang('Отзывы покупателей', 'light')} {if $visibleMainForm === false || $visibleMainForm == NULL}<button class="d_l_1" data-drop=".comments-main-form" data-place="inherit" data-overlay-opacity="0" data-after="Comments.toComment">{lang('Оставить свой отзыв', 'light')}</button>{/if}</div>
                                ...
                                {if $use_moderation}
                                    <label>
                                        <span class="frame-form-field">
                                            <div class="msg">
                                                <div class="success">
                                                    {lang('Комментарий будет отправлен на модерацию','light')}
                                                </div>
                                            </div>
                                        </span>
                                    </label>
                ...
                <form>
                    ...
                    <div class="frame-label">
                        <span class="frame-form-field">
                            ...
                            <span class="btn-form">
                                <input type="submit" value="{lang('Комментировать', 'light')}" onclick="Comments.post(this)"/>
                            </span>
                        </span>
                    </div>
                </form>
