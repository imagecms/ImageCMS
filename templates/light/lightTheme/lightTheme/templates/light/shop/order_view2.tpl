        ...
        {if $CI->session->flashdata('makeOrder') === true}
            <div class="f-s_0 without-crumbs">
                <div class="frame-title">
                    <h1 class="d_i">{lang('Спасибо, ваш заказ принят!<br/>Наши менеджеры свяжутся с вами.','light')}</h1>
                </div>
            </div>
        {/if}
        <div class="f-s_0 title-order-view without-crumbs">
            <div class="frame-title">
                <h1 class="d_i">{lang('Заказ №','light')}:<span class="number-order">{echo $model->getId()}</span></h1>
            </div>
        </div>
                        ...
                        <table class="table-order table-order-view">
                            ...
                            <tbody>
                                    ...
                                    <tr class="items items-bask items-order cart-product">
                                        <td class="frame-items">
                                            ...
                                            <div class="description">
                                                <span class="frame-variant-name-code">
                                                    ...
                                                    {if trim(ShopCore::encode($orderProduct->variant_id) != '')}<span class="frame-variant-code frameVariantCode">{lang("Артикул",'light')}: <span class="code js-code">{echo ShopCore::encode($orderProduct->variant_id)}</span></span>{/if}
                                                </span>
                                                {/*}
                                        ...
                                        <td>
                                            <div class="gen-sum-row">
                                                <span class="s-t d_b">{lang('Кол-во','light')}:</span>
                                                <span class="count">{echo $orderProduct->getQuantity()}</span>
                                                <span class="s-t">{lang('шт','light')}.</span>
                                            </div>
                                        </td>
                                        <td>
                                            <span class="s-t d_b">{lang('Сумма','light')}:</span>
                                            <span class="frame-prices">
                                                <span class="current-prices f-s_0">
                                                    <span class="price-new">
                                                        <span>
                                ...
                                {foreach $model->getOrderKits() as $orderProduct}
                                    <tr class="row-kits rowKits items-order row">
                                        ...
                                        <td>
                                            <span class="s-t">{lang('Сумма','light')}:</span>
                                            <span class="frame-prices">
                                                <span class="price-discount">
                                                    <span>
                            ...
                            <tfoot class="gen-info-price">
                                {if $model->getOriginPrice()}
                                    <tr>
                                        <td colspan="2">
                                            <span class="s-t">{lang('Сумма товаров','light')}</span>
                                        </td>
                                        <td>
                                            <span class="price-new">
                                                <span>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <span class="s-t">{lang('Стоимость доставки','light')}:</span>
                                    </td>
                                    <td>
                ...
                <div class="footer-bask">
                    <div class="inside-padd">
                        ...
                        <div class="gen-sum-order clearfix">
                            <span class="title f_l">{lang('К оплате с учетом доставки','light')}:</span>
