    ...
    <li class="globalFrameProduct item-WL {if $p.stock == 0}not-avail{/if}">
        ...
        <div class="description">
            ...
            <div class="funcs-buttons">
                ...
                {if $p.stock > 0}
                    <div class="frame-count-buy js-variant-{echo $p.variant_id} js-variant d_n">
            ...
            <div class="funcs-buttons-WL-item">
                <div class="btn-remove-item-wl">
                    <button
                        ...
                        ><span class="icon_remove"></span><span class="text-el d_l_black">{lang('Удалить', 'newLevel')}</span></button>
                </div>
                <div class="btn-move-item-wl">
                    <button
                        ...
                        data-always="true"
                        ><span class="icon_move"></span><span class="text-el d_l_black">{lang('Переместить', 'newLevel')}</span>
                    </button>
                </div>
            </div>
        {/if}
