        ...
        <div class="header-category f-s_0">
            <div class="inside-padd clearfix">
                ...
                <div class="frame-sort f-s_0 d_i-b">
                    <span class="title">{lang('Показывать','newLevelVertical')}:</span>
                    <div class="lineForm">
                ...
                <div class="frame-count-onpage d_i-b">
                    <div class="f-s_0 d_i-b">
                        <span class="title">{lang('На странице','newLevelVertical')}:</span>
                ...
                <nav class="frame-catalog-view f-s_0 d_i-b">
                    <span class="title">{lang('Смотреть','newLevelVertical')}:</span>
                    <ul class="tabs groups-buttons tabs-list-table" data-elchange="#items-catalog-main" data-cookie="listtable">
                        <li class="btn-def {if $_COOKIE['listtable'] == 'table' || $_COOKIE['listtable'] == NULl}active{/if}">
                            <button type="button" data-href="table" data-title="{lang('Таблица','newLevelVertical')}" data-rel="tooltip">
                                <span class="icon_table_cat"></span><span class="text-el">{lang('Таблица','newLevelVertical')}</span>
                            </button>
                        </li>
                        <li class="btn-def {if $_COOKIE['listtable'] == 'list'}active{/if}">
                            <button type="button" data-href="list" data-title="{lang('Список','newLevelVertical')}" data-rel="tooltip">
                                <span class="icon_list_cat"></span><span class="text-el">{lang('Список','newLevelVertical')}</span>
                            </button>
                        </li>
                    </ul>
                </nav>
