    ...
    <div class="container">
        <div class="f-s_0 title-login without-crumbs">
            <div class="frame-title">
                <h1 class="title">{lang('Вход','newLevelVertical')}</h1>
            </div>
        </div>
                    ...
                    <div class="frame-form-field">
                        <div class="clearfix">
                            ...
                            <div class="f_r neigh-buttonform">
                                ...
                                <button type="button" class="d_l_1" data-drop=".drop-forgot" data-source="{site_url('auth/forgot_password')}">{lang('Забыли Пароль?','newLevelVertical')}</button>
                            </div>
                        </div>
                    </div>
                </div>
