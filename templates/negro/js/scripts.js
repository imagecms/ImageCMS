...
var genObj = {
    ...
    popupCart: '#popupCart',
    emptyCarthideElement: "#popupCart table, #shopCartPage",
    emptyCartshowElement: "#popupCart .msg, #shopCartPageEmpty",
    pM: $('.paymentMethod'),
...
function deleteComprasionItem(el) {
    ...
    if (productsCGen == 1) {
        $('.page-compare').find(genObj.blockEmpty).hide()
