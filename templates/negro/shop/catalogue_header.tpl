        ...
        <nav class="f_l frame-catalog-view t-a_r">
            <ul class="tabs groups-buttons d_i-b" data-type="itemsView" data-elchange="#items-catalog-main" data-elchtglcls="list">
                <li {if $_COOKIE['listtable'] != 1}class="active"{/if}>
                    <button data-href="table">
                        <span class="icon_table-cat"></span><span class="text-el">Таблицей</span>
                    </button>
                </li>
                <li {if $_COOKIE['listtable'] == 1}class="active"{/if}>
                    <button data-href="list">
                        <span class="icon_list-cat"></span><span class="text-el">Списком</span>
                    </button>
                </li>
            </ul>
        </nav>
