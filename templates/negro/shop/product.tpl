    ...
    <div class="container">
        <div class="clearfix item-product">
                ...
                <div class="f-s_0 buy-block">
                    ...
                    <div class="btn-buy">
                        ...
                        <button
                            ...
                            data-prodid="{echo $model->getId()}"
                            type="button"
                            class="btn_not_avail variant">
                            <span class="icon_but"></span>
                        ...
                        <button
                            ...
                            data-prodid="{echo $model->getId()}" 
                            type="button"
                            class="btn_not_avail variant_{echo $pv->getId()} variant">
                            <span class="icon_but"></span>
                            <span class="text-el">{lang('s_message_o_report')}</span>
                        </button>
                        <!-- End. Notify button -->
                    ...
                    <!-- compare buttons ----------------------->
                    <div class="d_i-b">
                        <div class="btn-def f_l" data-title="В список сравнений"  data-prodid="{echo $model->getId()}" data-rel="tooltip">
            ...
            <div class="left-product">
                <a class="var_photo_{echo $v->getId()} prod_photo_block photo"  rel="group" id="photoGroup" href="{$model->firstVariant->getLargePhoto()}">
                ...
                <ul class="frame-thumbail">
                    ...
                    <li>
                        <a rel="group" href="{productImageUrl('/products/additional/'.$image->getImageName())}">
                            <span class="photo-block">
                                <span class="helper"></span>
        ...
        <div class="clearfix item-product">
            <div class="right-product f-s_0">
                <ul class="tabs tabs-data">
                    ...
                    <li>
                        <button type="button" data-href="#third" onclick="renderPosts(this)">
