...
<div class="frame-inside page-compare">
    <div class="container">
            ...
            <div class="no-empty js-no-empty">
                ...
                <div class="f-s_0 title-compare without-crumbs clearfix">
                    <div class="frame-title">
                        <h1 class="title">{lang('Сравнение товаров','boxGreen')}</h1>
                    </div>
                    <ul class="tabs groups-buttons tabs-compare-diferent" data-cookie="compare">
                        <li class="btn-def {if $_COOKIE['compare'] == "#all-params" || $_COOKIE['compare'] == NULL}active{/if}">
                            <button type="button" data-href="#all-params">
                                <span class="text-el">{lang('Все параметры','boxGreen')}</span>
                            </button>
                        </li>
                        <li class="btn-def {if $_COOKIE['compare'] == "#only-dif"}active{/if}">
                            <button type="button" data-href="#only-dif">
                                <span class="text-el">{lang('Только Различия','boxGreen')}</span>
                            </button>
                        </li>
                    </ul>
                </div>
                ...
                <div class="p_r">
                    ...
                    <div class="comprasion-head">
                        <div class="title-h3">{lang('Категория','boxGreen')}:</div>
            ...
            <div class="js-empty empty">
                ...
                <div class="msg layout-highlight layout-highlight-msg">
                    <div class="info">
                        ...
                        <span class="text-el">{lang('Вы удалили все товары из сравнения','boxGreen')}</span>
                    </div>
                </div>
            </div>
        ...
        {else:}
            <div class="f-s_0 title-compare without-crumbs clearfix">
                <div class="frame-title">
                    <h1 class="title">{lang('Cравнения товаров','boxGreen')}</h1>
                </div>
            </div>
            <div class="msg layout-highlight layout-highlight-msg">
                <div class="info">
                    <span class="icon_info"></span>
                    <span class="text-el">{lang('Список сравнения пуст','boxGreen')}</span>
                </div>
            </div>
        {/if}
    </div>
