<div class="drop drop-style drop-wishlist" id="wishListPopup">
    ...
    <div class="drop-header">
        <div class="title">
            {lang('Выбор cписка  желаний','boxGreen')}
        </div>
    </div>
                ...
                <form method="post" action="" onsubmit="return false;">
                    <div class="frame-radio">
                        ...
                        {if count($wish_lists) < $max_lists_count}
                            <div class="frame-label">
                                ...
                                <div class="name-count">
                                    <span class="text-el">{lang('Создать список','boxGreen')}</span>
                                </div>
                            </div>
                        {/if}
                    </div>
                    ...
                    <div class="btn-def">
                        <button
                            ...
                            {/if}
                            >
                            <span class="text-el">{if $wish_list_id}{lang('Переместить в список','boxGreen')}{else:}{lang('Добавить в список','boxGreen')}{/if}</span> 
                        </button>
                    </div>
                    {form_csrf()}
                </form>
