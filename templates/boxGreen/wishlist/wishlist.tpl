    ...
    <div class="container">
        <div class="f-s_0 title-cart without-crumbs">
            <div class="frame-title">
                <h1 class="title">{lang('Список желаний','boxGreen')}</h1>
            </div>
        </div>
        {if $errors}
        ...
        <div class="clearfix frame-tabs-ref">
            <div id="list-products" style="display: block;">
                <div class="frame-button-add-wish-list">
                    ...
                    <span class="help-block">{lang('В список избранных вы можете отложить понравившиеся товары, также показать список друзьям', 'boxGreen')}</span>
                </div>
                <div class="drop drop-style-2 drop-add-wishlist">
                    <div class="drop-header">
                        <div class="title">{lang('Создание списка избранных товаров','boxGreen')}</div>
                    </div>
                                        ...
                                        <div class="frame-form-field check-public">
                                            <div class="lineForm">
                                                <select name="wlTypes" id="wlTypes">
                                                    <option value="shared">{lang('Коллективный', 'boxGreen')}</option>
                                                    <option value="public">{lang('Публичный', 'boxGreen')}</option>
                                                    <option value="private">{lang('Приватный', 'boxGreen')}</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    {else:}
                                        <div class="msg layout-highlight layout-highlight-msg">
                                            <div class="info">
                                                ...
                                                <span class="text-el">{lang('Список пуст','boxGreen')}</span>
                                            </div>
                                        </div>
                                    {/if}
                                </div>
                ...
                {else:}
                    <div class="msg layout-highlight layout-highlight-msg">
                        <div class="info">
                            <span class="icon_info"></span>
                            <span class="text-el">{lang('Список Желания пуст','boxGreen')}</span>
                        </div>
                    </div>
                {/if}
            </div>
