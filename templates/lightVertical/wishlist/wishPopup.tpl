<div class="drop drop-style drop-wishlist" id="wishListPopup">
    ...
    <div class="drop-header">
        <div class="title">
            {lang('Выбор cписка  желаний','lightVertical')}
        </div>
    </div>
                ...
                <form method="post" action="" onsubmit="return false;">
                    <div class="frame-radio">
                        ...
                        {if count($wish_lists) < $max_lists_count}
                            <div class="frame-label">
                                ...
                                <div class="name-count">
                                    <span class="text-el">{lang('Создать список','lightVertical')}</span>
                                </div>
                            </div>
                        {/if}
                    </div>
                    ...
                    <div class="btn-buy">
                        <button
                            ...
                            {/if}
                            >
                            <span class="text-el">{if $wish_list_id}{lang('Переместить в список','lightVertical')}{else:}{lang('Добавить в список','lightVertical')}{/if}</span> 
                        </button>
                    </div>
                    {form_csrf()}
                </form>
