        ...
        {if !$CI->dx_auth->is_logged_in()}
            <li class="btn-enter">
                <button type="button"
                    ...
                    <span class="text-el">{lang('Вход','lightVertical')}</span>
                </button>
            </li>
        ...
        {else:}
            <li class="btn-personal-area">
                <button type="button" data-drop=".drop-profile" data-place="noinherit" data-overlay-opacity="0">
                    <span class="text-el ref t-d_n">{lang('Личный кабинет','lightVertical')}</span>
                        ...
                        <div class="inside-padd">
                            <nav>
                                <ul class="nav nav-profile nav-vertical">
                                    <li><a href="{site_url('/shop/profile/#my_data')}">{lang('Основные данные', 'lightVertical')}</a></li>
                                    <li><a href="{site_url('/shop/profile/#change_pass')}">{lang('Изменить пароль', 'lightVertical')}</a></li>
                                    <li><a href="{site_url('/shop/profile/#history_order')}">{lang('История заказа', 'lightVertical')}</a></li>
                                    <li>
                                    ...
                                    localStorage.removeItem('wishList');
                                                                    ...
                                                                    return false;">
                                            <span class="text-el">{lang('Выйти','lightVertical')}</span>
                                        </button>
                                    </li>
                                </ul>
                            </nav>
