...
<table class="table-order table-order-view">
    ...
    <tfoot class="gen-info-price">
        ...
        {if $gift_val}
            <tr>
                <td colspan="3">
                    <span class="s-t f_l">{lang('Подарочный сертификат','lightVertical')}:</span>
                            ...
                            {if $gift_error}
                                <div class="msg">
                                    <div class="error">
                                        ...
                                        <span class="text-el">{lang('Неверный подарочный сертификат', 'lightVertical')}</span>
                                    </div>
                                </div>
                            {else:}
                                <div class="btn-toggle-gift">
                                    <button type="button" class="d_l_1" data-drop="#gift" data-place="inherit" data-overlay-opacity="0">
                                        <span class="text-el">{lang('Ввести промо-код', 'lightVertical')}</span>
                                    </button>
                                </div>
                            {/if}
                            <div id="gift" class="{if !$gift_error}drop{/if} o_h">
                                <div class="btn-def f_r">
                                    <button type="button" id="giftButton">
                                        <span class="text-el">{lang('Применить', 'lightVertical')}</span>
                                    </button>
                                </div>
                                <div class="o_h">
