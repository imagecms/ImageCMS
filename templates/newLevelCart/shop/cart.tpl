                                ...
                                <div class="frame-label" id="frameDelivery">
                                    ...
                                    <div class="frame-form-field check-variant-delivery">
                                        ...
                                        <option
                                            ...
                                            data-spec-sum="{echo ceil($deliveryMethod->getDeliverySumSpecified())}"
                                            ...
                                            <div class="frame-label">
                                                <span class="niceRadio b_n">
                                                    <input type="radio"
                                                           ...
                                                           value="{echo $deliveryMethod->getId()}"
                                                           data-sum-spec="{echo ceil($deliveryMethod->getDeliverySumSpecified())}"
            ...
            <div class="right-cart">
                <div class="frameBask frame-bask frame-bask-order">
                    <div class="frame-title clearfix">
                        ...
                        <div class="f_r">
                            <button type="button" class="d_l_1" data-trigger="#showCart">Редактировать</button>
                        </div>
                    </div>
                    <div id="orderDetails">
