...
function initAdminArea(){
    ...
    if ($.exists('.sortable')) {
        ...
        $( ".sortable").sortable({
            ...
            cursor: 'move',
            scroll: false,
            cancel: '.head_body,.sortable .btn,.sortable .frame_label,.sortable td p, .sortable td span,.sortable td a,.sortable input,.sortable select, .buy_prod',
