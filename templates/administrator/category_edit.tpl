                                            ...
                                            <div class="group_icon pull-right">
                                                {if MAINSITE != ''}
                                                    <button type="button" class="btn btn-small" onclick="elFinderPopup('image', 'Img');
                                                            return false;"><i
                                                                class="icon-picture"></i>{lang("Choose an image ","admin")}
                                                    </button>
                                                {else:}
                                ...
                                <div class="form-horizontal">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <div class="o_h">
                                                <input type="text" name="main_tpl" value="{$main_tpl}" id="main_tp"/>
                                            </div>
                                            <p class="help-block">{lang('Main category template by default', 'admin')}
                                                main.tpl</p>
                                        </div>
                                    </div>
                                    <div class="control-group">
                                    ...
                                    <div class="control-group">
                                        ...
                                        <div class="controls">
                                            ...
                                            <p class="help-block">{lang('Page view template by default', 'admin')}
                                                page_full.tpl</p>
                                        </div>
                                    </div>
                                </div>
