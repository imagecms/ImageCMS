        ...
        <section class="mini-layout">
            <div class="frame_title clearfix">
                <div class="pull-left">
                    ...
                    <span class="title">{lang("Roles list")}</span>
                </div>
                <div class="pull-right">
                    <div class="d-i_b">
                        <button type="button" class="btn btn-small btn-danger disabled action_on" onclick="delete_function.deleteFunction()" id="del_sel_role"><i class="icon-trash icon-white"></i>{lang("Delete")}</button>
                        <a class="btn btn-small pjax btn-success" href="/admin/rbac/roleCreate" ><i class="icon-plus-sign icon-white"></i>{lang("New Role")}</a>
                    </div>
                </div>  
            </div>
            <div class="tab-content m-t_20">
                ...
                {else:}
                    ...
                    <div class="alert alert-info">
                        {lang("List")} {lang("Role")} {lang("Empty.")}
                    </div>
                {/if}
            </div>
        </section>
