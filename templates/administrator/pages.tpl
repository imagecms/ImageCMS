    ...
    <section class="mini-layout">
        <div class="frame_title clearfix">
            ...
            <div class="pull-right">
                ...
                pagesAdmin.updDialogMove();" type="button" class="btn btn-small disabled action_on pages_action" ><i class="icon-move"></i>{lang('move or displace')}</button>
                    <button onclick="$('#pages_delete_dialog').modal();
                pagesAdmin.updDialogCopy();" type="button" class="btn btn-small btn-danger disabled action_on pages_action pages_delete" ><i class="icon-trash icon-white"></i>{lang('Create page')}</button>
                    <!--<button type="button" class="btn btn-small btn-success" onclick="window.location.href='{$BASE_URL}admin/pages'"><i class="icon-plus-sign icon-white"></i>{lang('Create page')}</button>-->
                    <a class="btn btn-small btn-success pjax" href='{$BASE_URL}admin/pages'><i class="icon-plus-sign icon-white"></i>{lang('Create page')}</a>
                </div>
            </div>
        </div>
        <div class="row-fluid">
                ...
                <thead>
                    <tr>
                        ...
                        <th class="span3">{lang('Url')}</th>
                            ...
                            {/if}
                        <th class="span2">{lang('Creation date')}</th>
                    ...
                    <tr class="head_body">
                        ...
                        <td class="number">
                            <input type="text" name="id" data-original-title="{lang('numbers_only')}" value="{$_POST['id']}"/>
                        </td>
                        <td>
