<section class="mini-layout">
    <div class="frame_title clearfix">
        <div class="pull-left">
            ...
            <span class="title">{lang("Editing")} {lang("Privileges")}</span>
        </div>
        <div class="pull-right">
            <div class="d-i_b">
                <a href="{$BASE_URL}admin/rbac/privilegeList" class="t-d_n m-r_15 pjax"><span class="f-s_14">←</span> <span class="t-d_u">{lang("Back")}</span></a>
                <button type="button" class="btn btn-small btn-primary formSubmit" data-form="#priv_ed_form" data-action="close" data-submit><i class="icon-ok"></i>{lang("Have been saved")}</button>
                <button type="button" class="btn btn-small formSubmit" data-form="#priv_ed_form" data-action="exit"><i class="icon-check"></i>{lang("Save and go back")}</button>    
                        ...
                        <td colspan="6">
                            <div class="inside_padd span9">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="Title">{lang("Description")}:</label>
                                    <div class="controls">
                                ...
                                <div class="control-group">
                                    <label class="control-label" for="GroupId">{lang("Group")}</label>
                                    <div class="controls">
