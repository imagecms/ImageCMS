<div class="clearfix">
    <input type="text" id="prorerties_filter" style="width: 300px;" placeholder="{lang('Start typing property name here','greyVision')}">
    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        <thead>
            <tr>
                ...
                <th class="span5">
                    {lang('Name', 'greyVision')}
                </th>
                <th class="span5">
                    {lang('Type', 'greyVision')}
                </th>                               
            </tr>
        </thead>
        <tbody>
