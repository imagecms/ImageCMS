{# Useful methods:
 ...
 # @method   SStringHelper::Pluralize(ShopCore::app()->SWishList->totalItems(), array( lang('Товар']),lang('продукт','webinger'),lang('продукт','webinger')))
 # @var      $CS
}
<div style="margin-top: 9px;" id="wishListData">
    ...
    <span class="d_n" data-rel="ref">
        <a {if ShopCore::$ci->dx_auth->is_logged_in()===true}logged_in="true" href="{shop_url('wish_list/')}"{else:}href="#"{/if} id="towishlist" class="d_n f-s_0">
            ...
            <span class="text-el">{echo lang('Список желаний','webinger')}</span>
        </a>
    </span>
