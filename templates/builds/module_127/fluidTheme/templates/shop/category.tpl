    ...
    <div class="container">
        <div class="filter left-catalog">
            <div class="btn-additional-s_c2 mq-w-320 mq-block m-b_0">
                <button type="button">
                    <span class="text-el" data-hide='<span class="d_l">{lang('Скрыть фильтр','newLevel')}</span> <span class="icon-show-part up"></span>' data-show='<span class="d_l">{lang('Показать фильтр','newLevel')}</span> <span class="icon-show-part"></span>'></span>
                </button>
            </div>
