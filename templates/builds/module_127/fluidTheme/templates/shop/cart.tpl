                            ...
                            <div class="inside-padd">
                                ...
                                <div class="groups-form">
                                    ...
                                    <div class="frame-label">
                                        <label class="title" for="cart-phone">
                                            <span class="p_r">
                                        ...
                                        <div class="frame-form-field">
                                            ...
                                            <div class="d_b o_h maskPhoneFrame">
                                                <input type="text" name="userInfo[phone]" id="cart-phone" value="{$profile.phone}" class="m-b_5">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="frame-label">
                                        <div class="drop drop-add-phone maskPhoneFrame">
