                                ...
                                {foreach $model->getOrderKits() as $orderProduct}
                                    <tr class="row-kits rowKits items-order row">
                                        <td class="frame-items frame-items-kit">
                                            <div class="p_r">
                                                <div class="main-title">{lang('Комплект товаров', 'newLevel')}</div>
                                        ...
                                        <td>
                                            <span class="plus-minus">{echo $orderProduct->getQuantity()}</span>
                                            <span class="text-el">{echo SStringHelper::Pluralize($orderProduct->getQuantity(), array(lang('комплект','newLevel'),lang('комплекта','newLevel'),lang('комплектов','newLevel')))}</span>
                                        </td>
                                        <td class="frame-cur-sum-price">
                                            <span class="frame-prices">
                                                <span class="price-discount">
