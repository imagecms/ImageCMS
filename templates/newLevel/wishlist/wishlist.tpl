            ...
            <li class="clearfix">
                <div class="frame-photo-title">
                    <form action="{site_url('/wishlist/do_upload')}" method="post" accept-charset="utf-8" enctype="multipart/form-data">
                        ...
                        <span class="help-block f-s_11">{lang('Максимальный размер','newLevel')} {echo $settings[maxImageWidth]}&times;{echo $settings[maxImageHeight]} {lang('пикселей','newLevel')}</span>
                        {form_csrf()}
                    </form>
                </div>
