...
<div class="error">
	...
	<p>{lang('The required template file for the menu not found','newLevel')}<b>{$menu}</b></p>
	<ul>
	{foreach $errors as $e}
	...
	<p>
		{if $tpl_folder}
		{lang('Check the file existence or change the menu settings','newLevel')} <b>{$menu}</b>
		{else:}
