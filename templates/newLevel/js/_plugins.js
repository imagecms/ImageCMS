    ...
    var methods = {
        ...
        get: function(el, modal, e) {
            ...
            if (elSet.drop != undefined) {
                ...
                var drop = methods._pasteDrop($.extend({}, methods.dP, elSet), methods.dP.pattern, methods.dP.drop.replace('.', '') + ' ' + methods.dP.curDefault, el.get(0).rel.replace(/[^a-zA-Z0-9]+/ig, ''));
