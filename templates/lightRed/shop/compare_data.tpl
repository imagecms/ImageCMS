...
<div class="compare-list-btn tinyCompareList">
    <button data-href="{shop_url('compare')}" data-drop=".drop-info-compare" data-place="inherit" data-overlay-opacity="0">
        <span class="icon_compare_list"></span>
        <span class="text-compare-list">
            <span class="js-empty empty" {if $count == 0}style="display: inline"{/if}>
                <span class="text-el">{lang('Товары на сравнение','lightRed')} </span>
...
<div class="drop drop-info drop-info-compare">
    ...
    <span class="text-el">
        {lang('Ваш список', 'lightRed')} <br/>
        “{lang('Список сравнения', 'lightRed')}” {lang('пуст', 'lightRed')}</span>
</div>