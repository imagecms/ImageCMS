...
<div class="frame-inside page-order">
    <div class="container">
        ...
        <div class="f-s_0 title-order-view without-crumbs">
            <div class="frame-title">
                <h1 class="title">{lang('Заказ №','lightRed')}:<span class="number-order">{echo $model->getId()}</span></h1>
            </div>
        </div>
        ...
        <div class="left-order">
            ...
            <table class="table-info-order">
                ...
                {if $s_field.field_data && $s_field.field_data !== ''}
                    <tr>
                        <th>{lang('Дополнительный телефон','lightRed')}:</th>
                        ...
                        <table class="table-order table-order-view">
                                ...
                                {foreach $model->getOrderProducts() as $orderProduct}
                                    ...
                                    <tr class="items items-bask items-order cart-product">
                                        <td class="frame-items">
                                            ...
                                            <div class="description">
                                                <span class="frame-variant-name-code">
                                                    ...
                                                    {if trim(ShopCore::encode($Variant->getNumber()) != '')}<span class="frame-variant-code frameVariantCode">{lang("Артикул",'lightRed')}: <span class="code js-code">{echo ShopCore::encode($Variant->getNumber())}</span></span>{/if}
                                                </span>
                                                {/*}
                                        ...
                                        <td>
                                            ...
                                            <span class="text-el">{lang('шт','lightRed')}.</span>
                                        </td>
                            ...
                            <tfoot class="gen-info-price">
                                ...
                                {if $discount}
                                    <tr>
                                        <td colspan="3">
                                            <span class="s-t f_l">{lang('Начальная стоимость товаров','lightRed')}</span>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <span class="s-t f_l">{lang('Cтоимость товаров','lightRed')}</span>
                                ...
                                {if $deliveryMethod}
                                    <tr>
                                        <td colspan="3">
                                            <span class="s-t f_l">{lang('Доставка','lightRed')}:</span>
                                            <div class="f_r">
                                                {if !$deliveryMethod->getDeliverySumSpecified()}
                                                    ...
                                                    {if $cartPrice < $priceDelFreeFrom}
                                                        ...
                                                        {/if}
                                                    {else:}
                                                        <span class="text-el s-t">{lang('Бесплатно', 'lightRed')}</span>
                                                    {/if}
                                                {else:}
                                ...
                                {if $discount}
                                    <tr>
                                        <td colspan="3">
                                            <span class="s-t f_l">{lang('Ваша текущая скидка','lightRed')}:</span>
