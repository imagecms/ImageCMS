<div class="drop drop-report drop-style">
    ...
    <div class="drop-header">
        <div class="title">{lang('Сообщить о появлении','lightRed')}</div>
    </div>
    ...
    <div class="d_n" data-clone="data-report">
        <form method="post" action="" id="data-report" onsubmit="ImageCMSApi.formAction('{site_url("/shop/ajax/getApiNotifyingRequest")}', '#data-report', {literal}{durationHideForm: 10000, drop: '.drop-report', callback: function(msg, status, form, DS) {
                    if (status) {
            ...
            <div class="horizontal-form">
                ...
                <label>
                    ...
                    <span class="frame-form-field">
                        ...
                        <span class="must">*</span>
                        <span class="help-block">{lang('Вы получите письмо, когда товар будет доступен','lightRed')}</span>
                    </span>
                </label>
                <label>
                ...
                <label>
                    <span class="title">{lang('Комментарий:','lightRed')}</span>
                ...
                <div class="frame-label">
                    ...
                    <span class="frame-form-field">
                        <div class="btn-form">
                            <button type="submit">
                                <span class="text-el">{lang('Отправить','lightRed')}</span>
                            </button>
                        </div>
                    </span>
                </div>
