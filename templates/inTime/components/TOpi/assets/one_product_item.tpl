            ...
            <div class="left-description">
                ...
                {if $opi_codeArticle}
                    <div class="frame-variant-name-code">
                        ...
                        <span class="frame-variant-code frameVariantCode" {if $hasCode}style="display:none;"{/if}>{lang('Артикул','inTime')}:
                        ...
                        {if count($variants) > 1}
                            ...
                            <span class="frame-variant-name frameVariantName" {if $hasVariant}style="display:none;"{/if}>{lang('Вариант','inTime')}:
                                <span class="code js-code">
                                    {if !$hasVariant}
                ...
                {if !$opi_widget && !$opi_defaultItem && !$opi_compare && !$opi_wishListPage}
                    {if count($variants) > 1}
                        <div class="check-variant-catalog f-s_0">
                            <span class="s-t m-r_5 v-a_m">{lang('Вариант', 'inTime')}</span>
                ...
                {foreach $variants as $key => $pv}
                    {if $pv->getStock() == 0}
                        <div class="m-b_5    js-variant-{echo $pv->getId()} js-variant" {if $key != 0}style="display:none"{/if}>
                            <span class="c_6 f-w_b">{lang('Нет в наличии', 'inTime')}</span>
                        </div>
                    {/if}
                {/foreach}
                <!-- Start. Prices-->
                                        ...
                                        <form method="POST" action="/shop/cart/addProductByVariantId/{echo $pv->getId()}">
                                            <div class="btn-buy btn-cart{if !$inCart} d_n{/if}">
                                                <button
                                                    ...
                                                    class="btnBuy"
                                                    data-rel="tooltip"
                                                    data-title="{lang('Уже в корзине', 'inTime')}"
                                                    >
                                            ...
                                            <div class="btn-buy{if $inCart} d_n{/if}">
                                                <button
                                                    ...
                                                    data-rel="tooltip"
                                                    data-title="{lang('Добавить в корзину', 'inTime')}"
                                ...
                                {else:}
                                    <div class="btn-not-avail js-variant-{echo $pv->getId()} js-variant" {if $key != 0}style="display:none"{/if}>
                                        <button
                                            class="infoBut"
                                            type="button"
                                            data-title="{lang('Узнать о наличии','inTime')}"
                                            data-rel="tooltip"
                                    ...
                                    <div class="frame-btn-comp">
                                        ...
                                        <div class="btn-compare">
                                            <button class="toCompare"
                                                    ...
                                                    type="button"
                                                    data-firtitle="{lang('В список сравнений','inTime')}"
                                                    data-sectitle="{lang('В списке сравнений','inTime')}"
                                                    data-title="{lang('В список сравнений','inTime')}"
                                                    data-rel="tooltip">
                                                <span class="icon_compare"></span>
                                                <span class="text-el d_l">{lang('В список сравнений','inTime')}</span>
                                            </button>
                                        </div>
                ...
                <div class="funcs-buttons-WL-item">
                    <div class="btn-remove-item-wl">
                        <button
                            ...
                            ><span class="icon_remove"></span><span class="text-el d_l_1">{lang('Удалить', 'inTime')}</span></button>
                    </div>
                    <div class="btn-move-item-wl">
                        <button
                            ...
                            data-always="true"
                            ><span class="icon_move"></span><span class="text-el d_l_1">{lang('Переместить', 'inTime')}</span>
                        </button>
                    </div>
                </div>
            {/if}
