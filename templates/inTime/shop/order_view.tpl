    ...
    <div class="container">
        {if $CI->session->flashdata('makeOrder') === true}
            <div class="f-s_0 without-crumbs">
                <div class="frame-title">
                    <h1 class="title">{lang('Спасибо, ваш заказ принят!', 'inTime')}<br/>{lang('Наши менеджеры свяжутся с вами.','inTime')}</h1>
                </div>
            </div>
        {/if}
        <div class="f-s_0 title-order-view without-crumbs">
            <div class="frame-title">
                <h1 class="title">{lang('Заказ №','inTime')}:<span class="number-order">{echo $model->getId()}</span></h1>
            </div>
        </div>
        ...
        <div class="left-order">
            ...
            <table class="table-info-order">
                ...
                <tr>
                    <th>{lang('Имя получателя','inTime')}:</th>
                    <td>{echo $model->getUserFullName()}</td>
                </tr>
                {if $model->getUserPhone()}
                    <tr>
                        <th>{lang('Телефон','inTime')}:</th>
                ...
                {if $s_field.field_data && $s_field.field_data !== ''}
                    <tr>
                        <th>{lang('Дополнительный телефон','inTime')}:</th>
                ...
                {if $model->getDeliveryMethod()}
                    ...
                    <tr>
                        <th>{lang('Способ доставки','inTime')}:</th>
                        <td>
                ...
                {if $paymentMethod}
                    <tr>
                        <th>{lang('Способ оплаты','inTime')}:</th>
                        <td>
                ...
                <!--                Start. Order status-->
                <tr>
                    <th>{lang('Статус оплаты','inTime')}:</th>
                    <td>
                        {if $model->getPaid() == true}
                            <span class="status-pay paid">{lang('Оплачен','inTime')}</span>
                        {else:}
                            <span class="status-pay not-paid">{lang('Не оплачен','inTime')}</span>
                        {/if}
                    </td>
                </tr>
                <!--                End. Order status-->
                        ...
                        <table class="table-order table-order-view">
                                ...
                                {foreach $model->getOrderProducts() as $orderProduct}
                                    ...
                                    <tr class="items items-bask items-order cart-product">
                                        <td class="frame-items">
                                            ...
                                            <div class="description">
                                                <span class="frame-variant-name-code">
                                                    {if trim(ShopCore::encode($orderProduct->variant_name) != '')}<span class="frame-variant-name frameVariantName">{lang("Вариант",'inTime')}: <span class="code js-code">{echo ShopCore::encode($orderProduct->variant_name)}</span></span>{/if}
                                                    {if trim(ShopCore::encode($Variant->getNumber()) != '')}<span class="frame-variant-code frameVariantCode">{lang("Артикул",'inTime')}: <span class="code js-code">{echo ShopCore::encode($Variant->getNumber())}</span></span>{/if}
                                                </span>
                                                {/*}
                                        ...
                                        <td>
                                            ...
                                            <span class="text-el">{lang('шт','inTime')}.</span>
                                        </td>
                                ...
                                {foreach $model->getOrderKits() as $orderProduct}
                                    <tr class="row-kits rowKits items-order row">
                                        <td class="frame-items frame-items-kit">
                                            <div class="title">{lang('Комплект товаров', 'inTime')}</div>
                            ...
                            <tfoot class="gen-info-price">
                                ...
                                {if $discount}
                                    <tr>
                                        <td colspan="3">
                                            <span class="s-t f_l">{lang('Начальная стоимость товаров','inTime')}</span>
                                            <div class="f_r">
                                                <span class="price-new">
                                                    <span>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <span class="s-t f_l">{lang('Cтоимость товаров','inTime')}</span>
                                ...
                                {if $deliveryMethod}
                                    <tr>
                                        <td colspan="3">
                                            <span class="s-t f_l">{lang('Доставка','inTime')}:</span>
                                            <div class="f_r">
                                                {if !$deliveryMethod->getDeliverySumSpecified()}
                                                    ...
                                                    {if $cartPrice < $priceDelFreeFrom}
                                                        ...
                                                        {/if}
                                                    {else:}
                                                        <span class="text-el s-t">{lang('Бесплатно', 'inTime')}</span>
                                                    {/if}
                                                {else:}
                                ...
                                {if $discount}
                                    <tr>
                                        <td colspan="3">
                                            <span class="s-t f_l">{lang('Ваша текущая скидка','inTime')}:</span>
                                ...
                                {if $model->getGiftCertPrice() > 0}
                                    <tr>
                                        <td colspan="3">
                                            <span class="s-t">{lang('Подарочный сертификат','inTime')}:</span>
                                            <span class="price-item f_r">
                ...
                <div class="footer-bask">
                    <div class="inside-padd">
                        ...
                        <div class="gen-sum-order clearfix">
                            <span class="title f_l">{lang('Всего к оплате','inTime')}:</span>
