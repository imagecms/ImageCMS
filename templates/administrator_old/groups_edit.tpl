<form action="{$BASE_URL}admin/groups/save/{$id}" method="post" id="groups_edit_form" style="width:100%;">
	...
	<div class="form_input"><input type="text" name="name" value="{$name}" id="name" class="textbox_short"> <h5>({lang('a_just_lat')})</h5></div>
	<div class="form_overflow"></div>
	...
	<div class="form_input"><input type="submit" name="button" class="button"  value="{lang('a_save')}" onclick="ajax_me('groups_edit_form');" ></div>
	<div class="form_overflow"></div>
{form_csrf()}</form>