<div class="drop drop-report drop-style">
    ...
    <div class="drop-header">
        <div class="title">{lang('Сообщить о появлении','greyVision')}</div>
    </div>
            ...
            <div class="horizontal-form">
                ...
                <label>
                    ...
                    <span class="frame-form-field">
                        ...
                        <span class="must">*</span>
                        <span class="help-block">{lang('Вы получите письмо, когда товар будет доступен','greyVision')}</span>
                    </span>
                </label>
                <label>
                ...
                <label>
                    <span class="title">{lang('Комментарий:','greyVision')}</span>
                ...
                <div class="frame-label">
                    ...
                    <span class="frame-form-field">
                        <div class="btn-form">
                            <button type="submit">
                                <span class="text-el">{lang('Отправить','greyVision')}</span>
                            </button>
                        </div>
                    </span>
                </div>
