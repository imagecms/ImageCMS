...
<div class="drop drop-info drop-info-wishlist">
    ...
    <span class="text-el">
        ...
        “{lang('Список желаний', 'greyVision')}” {lang('пуст', 'greyVision')}</span>
</div>