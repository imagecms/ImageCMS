                                        ...
                                        {if $productVariant->getStock() > 0}
                                            <div class="frame-count-buy variant_{echo $productVariant->getId()} variant" {if $key != 0}style="display:none"{/if}>
                                                <div class="frame-count frameCount">
                                                    <div class="number framePlusMinus" data-title="{lang('Количество на складе','newLevel')} {echo $productVariant->getstock()}" data-prodid="{echo $model->getId()}" data-varid="{echo $productVariant->getId()}">
                                                        ...
                                                        <input type="text" value="1" class="plusMinus" data-title="{lang('Только цифры','newLevel')}" data-min="1" data-max="{echo $productVariant->getstock()}">
                                                    </div>
                                                </div>
