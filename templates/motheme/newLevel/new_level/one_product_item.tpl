                        ...
                        <div class="frame-count-buy variant_{echo $pv->getId()} variant" {if $key != 0}style="display:none"{/if}>
                            {if !$opi_widget && !$opi_defaultItem}
                                <div class="frame-count frameCount">
                                    <div class="number framePlusMinus" data-title="{lang('Количество на складе','newLevel')} {echo $pv->getstock()}" data-prodid="{echo $p->getId()}" data-varid="{echo $pv->getId()}">
                                        ...
                                        <input type="text" value="1" class="plusMinus" data-title="{lang('Только цифры','newLevel')}" data-min="1" data-max="{echo $pv->getstock()}">
                                    </div>
                                </div>
                            {/if}
                            <div class="btn-buy">
