                ...
                {if $p.stock > 0}
                    <div class="frame-count-buy variant_{echo $p.variant_id} variant">
                        <div class="frame-count frameCount">
                            <div class="number framePlusMinus" data-title="{lang('количество на складе', 'newLevel')} {echo $p.stock}" data-prodid="{echo $p.id}" data-varid="{echo $p.variant_id}">
                                ...
                                <input type="text" value="1" class="plusMinus" data-title="{lang('только цифры', 'newLevel')}" data-min="1" data-max="{echo $p.stock}">
                            </div>
                        </div>
                        <div class="btn-buy">
                            <button
