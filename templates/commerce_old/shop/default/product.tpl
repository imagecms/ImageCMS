...
<div class="products_list">
    ...
    <div id="product" style="width:380px;">
        ...
        return false;' class="button1">{echo ShopCore::t('ДОБАВИТЬ В КОРЗИНУ')}</a>
                {else:}
        ...
        return false;' class="button1">{echo ShopCore::t('ДОБАВИТЬ В WISH LIST')}</a>
...
<div style="float: right;">
    {if $isAvailable}
        ...
        return false;'>{echo ShopCore::t('Добавить комплект в корзину')}</a>
    {else:}
        Нет на складе
    {/if}
</div>
