    ...
    <div class="fon-header">
        <div class="form-create-shop">
            <div class="container">
                ...
                <div class="short-descr">{lang('Бесплатная версия на 14 дней. Название магазина можете изменить позже', 'newLevel')}</div>
                <form mentod="post" action="#">
                    <div class="f-s_0">
                        <div class="f-s_0 d_i-b v-a_t">
                            <input type="text" placeholder="{lang('Название магазина', 'newLevel')}"/>
