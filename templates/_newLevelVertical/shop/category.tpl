    ...
    <div class="container">
        <div class="right-catalog">
            ...
            <div class="f-s_0 title-category">
                ...
                <span class="count">({$totalProducts} {echo SStringHelper::Pluralize($totalProducts, array(lang('товар','newLevelVertical'),lang('товара','newLevelVertical'),lang('товаров','newLevelVertical')))})</span>
            </div>
            ...
            {if $totalProducts == 0}
                ...
                <div class="msg layout-highlight layout-highlight-msg">
                    <div class="info">
                        ...
                        <span class="text-el">{lang('Не найдено товаров','newLevelVertical')}</span>
                    </div>
                </div>
                <!-- End. Empty category-->
            {/if}
                ...
                <div class="frame-category-menu layout-highlight">
                    <div class="title-menu-category">
                        <div class="title-default">
                            <div class="title-h3 title">{lang('Категории', 'newLevelVertical')}:</div>
                        </div>
                    </div>
