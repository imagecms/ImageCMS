<div id="titleExt"><h5>{widget('path')}<span class="ext">{lang("Registration")}</span></h5></div>
...
<form action="" class="form" method="post">
	...
	<div class="textbox">
        <label for="email" class="left">{lang("Email")}</label>
    ...
    <div class="textbox">
        <label for="username" class="left">{lang("Name")}</label>
    ...
    <div class="textbox"
        <label for="confirm_password" class="left">{lang("Repeat Password")}</label>
