...
<div class="frame-inside page-wishlist">
    <div class="container">
        ...
        <div class="clearfix frame-tabs-wish">
                    ...
                    <div class="inside-padd">
                        ...
                        <div class="items-carousel frame-scroll-pane">
                            <div class="content-carousel container">
                                <ul class="items items-catalog items-wish-list items-h-carousel items-product">
                            ...
                            <div>
                                <div class="funcs-buttons-wishlist f_l">
                                    <div class="btn-def">
                                        ...
                                        data-always="true"
                                        >
                                        <span class="icon_edit_w"></span>
                                        <span class="text-el">{lang('Редактировать список','newLevel')}</span>
                                    </button>
                                </div>

                            </div>
                            {if $wishlist[0]['access'] == 'shared' || $wishlist[0]['access'] == 'public'}
                            <div class="btn-def btn-send-wishlist">
    ...
    <div class="frame-wish-list">
        <div class="title">
            <span class="text-el">{lang('Создать новый список','newLevel')}</span>
        </div>
        <div class="frame-add-wish-list f_l">
            <div class="wishlist-content2">
                <div class="inside-padd">
                    <div class="horizontal-form big-title">
                        <form method="POST" action="{site_url('/wishlist/wishlistApi/createWishList')}">
                            ...
                            <label>
                                <span class="title">{lang('Название','newLevel')}</span>
                            ...
                            <div class="frame-label">
                                ...
                                <div class="frame-form-field">
                                    <div class="btn-form">
                                        ...
                                        >
                                        <span class="text-el">{lang('сохранить список','newLevel')}</span>
                                    </button>
                                </div>
                            </div>
                        </div>
    ...
    <div class="wishlist-data-users f_r">
        <div class="title">
            <span class="text-el">{lang('Дополнительные данные','newLevel')}</span>
        </div>
                ...
                <div class="frame-label">
                    ...
                    <div class="frame-form-field">
                        <div class="btn-form">
                            ...
                            >
                            <span class="text-el">{lang('сохранить данные','newLevel')}</span>
                        </button>
                    </div>
                </div>
            </div>
    ...
    <li class="clearfix">
        <div class="frame-photo-title">
                    ...
                    <div class="group-buttons f-s_0">
                        <label class="btn-edit-photo-wishlist" for="img">
                            <button type="button" class="p_r hidden">
                                ...
                                <input id="img" data-wishlist="image" value="{lang('Добавить фото','newLevel')}" type="file" name="file" size="20" accept="image/gif, image/jpeg, image/png, image/jpg"/>
                            </button>
                        </label>
                        {if $user['user_image']!=''}
            ...
            <div class="download-btn">
                <button type="button" class="p_r hidden pointer">
                    <span class="icon_add_photo"></span>
                    <span class="text-el">{lang('Добавить фото','newLevel')}</span>
                    <input id="imgfile" data-wishlist="image" value="{lang('Добавить фото','newLevel')}" type="file" name="file" size="20" accept="image/gif, image/jpeg, image/png, image/jpg"/>
                </button>
            </div>
