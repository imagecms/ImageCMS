...
<li class="globalFrameProduct{if $p->firstVariant->getStock() == 0} not-avail{else:}{if $inCartFV} in-cart{else:} to-cart{/if}{/if} {if intval(($key+1)/3) - ($key+1)/3 == 0}right{else:}left{/if}" data-pos="top">
    ...
    <a href="{shop_url('product/' . $p->getUrl())}" class="frame-photo-title" title="{echo ShopCore::encode($p->getName())}">
        ...
        {$brand = $brand->getName()}
        {$hasBrand = trim($brand) != ''}
        <span class="frame-item-brand c_9 f-s_11 t-t_u">
            {if $hasBrand}
            {echo trim($brand)}
            {/if}
        </span>
    ...
    <div class="description">
        ...
        <!-- Start. Check variant-->
        {if !$opi_defaultItem && !$opi_compare && !$opi_wishListPage}
        {if count($variants) > 1}
        ...
        {if !$opi_defaultItem}
                        <div class="funcs-buttons no-vis-table" {if $opi_widget}style="display: none !important;"{/if}>
                    ...
                    <div class="btn-buy{if $inCart} d_n{/if}">
                        ...
                        >
                        <span class="icon_cleaner_buy"></span>
                        <span class="text-el">{lang('в корзину', 'newLevel')}</span>
                    </button>
                </div>
                {form_csrf()}
            </form>
        ...
        {else:}
            ...
            <span class="c_6 f-s_11 t-t_u d_i-b notAvail">{lang('нет в наличии', 'newLevel')}</span>
...
<!-- End. Collect information about Variants, for future processing -->
        <div class="frame-contain-buttons" {if $opi_widget}style="display: none !important;"{/if}>
...
<div class="frame-star d_i-b v-a_m">
...
<div class="frame-wish-compare-list no-vis-table f-s_0">
    {if $opi_wishlist}
    ...
    <div class="frame-btn-comp">
        ...
        <div class="btn-compare">
            ...
            <span class="text-el d_l f-s_11">{lang('В список сравнений','newLevel')}</span>
        </button>
    </div>
...
<div class="funcs-buttons-WL-item">
    <div class="btn-remove-item-wl">
        ...
        ><span class="icon_remove"></span></button>
    </div>
{/*}
