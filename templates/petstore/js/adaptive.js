(function(wnd, body, isTouch) {
    ...
    constructAdaptive.prototype.resize = function(wWidth) {
        ...
        if (wWidth < 480) {
            $('.banerMain .cycle').cycle('destroy');
            $('.banerMain').append($('.addBaner').clone());
            $('.banerMain img').css('opacity', '');
            initCarouselJscrollPaneCycle($('.frame-baner-start_page'));
        }
        else {
            $('.banerMain .addBaner').remove();
            initCarouselJscrollPaneCycle($('.frame-baner-start_page'));
        }
        if (menuTimeout)
