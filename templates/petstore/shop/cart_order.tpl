...
<table class="table-order">
                        ...
                        <div class="description">
                            {if $item->getName() && trim($item->getName()) != trim($item->getSProducts()->getName())}
                                <span class="frame-variant-name">
                                    <span class="c_6">{echo trim($item->getName())}</span>
                                </span>
                            {/if}
                            {if $item->getNumber()}
                                    ...
                                    <div class="frame-kit">
                                        ...
                                        <div class="description">
                                            {if $kitItem->getName() && trim($kitItem->getName()) != trim($kitItem->getSProducts()->getName())}
                                                <span class="frame-variant-name">
                                                    <span class="c_6">{echo $kitItem->getName()}</span>
                                                </span>
                                            {/if}
    ...
    <tfoot class="gen-info-price">
        {if $discount_val}
            <tr>
                <td colspan="3" class="o_h">
                    <span class="c_6 f_l dotted_underline">{lang('Начальная стоимость товаров','newLevel')}:</span>
                    <div class="f_r">                
        ...
        <tr>
            <td colspan="3" class="o_h">
                <span class="c_6 f_l dotted_underline">{lang('Cтоимость товаров','newLevel')}:</span>
                <div class="f_r">
        ...
        {if $deliveryMethod && $deliveryMethod->getPrice() != 0 || $deliveryMethod && $deliveryMethod->getDeliverySumSpecifiedMessage() != ''}
            <tr>
                <td colspan="3" class="o_h">
                    <span class="c_6 f_l dotted_underline">{lang('Доставка','newLevel')}:</span>
                    <div class="f_r c_6">
                        {if !$deliveryMethod->getDeliverySumSpecified()}
                            ...
                            {if $cartPrice < $priceDelFreeFrom}
                                {$cartPrice += $priceDel}
                                <span class="price">{echo $priceDel}</span>
                                <span class="curr">{$CS}</span>
                               {/*}
                                {if $NextCSId}
                               ...
                               { */}
                            {else:}
                                <span class="text-el c_6 ">{lang('Бесплатно', 'newLevel')}</span>
                            {/if}
                        {else:}
                            <span class="text-el c_6 ">{echo $deliveryMethod->getDeliverySumSpecifiedMessage()}</span>
                        {/if}
                    </div>
                </td>
            </tr>
        ...
        {if $discount_val}
            <tr>
                <td colspan="3" class="o_h">
                    <span class="c_6 f_l dotted_underline">{lang('Ваша текущая скидка','newLevel')}:</span>
                    <div class="text-discount current-discount f_r c_6">
                                        <span class="price ">{echo ShopCore::app()->SCurrencyHelper->convert($discount_val)}</span>
                                    <span class="curr">{$CS}</span>
                    </div>
                </td>
            </tr>
        ...
        {if $gift_val}
            <tr>
                <td colspan="3" class="o_h">
                    <span class="c_6 f_l dotted_underline">{lang('Подарочный сертификат','newLevel')}:</span>
        ...
        {elseif $CI->load->module('mod_discount/discount_api')->isGiftCertificat()}
            <tr>
                <td colspan="3" class="o_h">
                    <div class="clearfix">
                        <span class="c_6  f_l dotted_underline">{lang('Промо-код','newLevel')}:</span>
                        <div class="frame-gift f_r">
                            {if $gift_error}
                                <div class="msg">
                                    <div class="error">
                                        <span class="icon_error"></span>
                                        <span class="text-el">{lang('Неверный промо-код', 'newLevel')}</span>
                                    </div>
                                </div>
                            {else:}
                                <div class="btn-toggle-gift">
                                    <button type="button"  data-drop="#gift" data-place="inherit" data-overlay-opacity="0">
                                        <span class="text-el a_g">{lang('Ввести промо-код', 'newLevel')}</span>
                                    </button>
                                </div>
                            {/if}
...
<div class="gen-sum-order footer-bask">
    <div class="inside-padd clearfix">
        ...
        <span class="frame-prices f_r m-t_7">
            <span class="current-prices f-s_0">
                <span class="price-new f-w_b">
                    <span>
                        <span class="price f-s_18" id="finalAmount">
                            {echo ShopCore::app()->SCurrencyHelper->convert($cartPrice)}
                        </span>
                        <span class="curr f-s_15">{$CS}</span>
                    </span>
                </span>
                {if $NextCS != null}
                    <span class="price-add">
