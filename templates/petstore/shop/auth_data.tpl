<div class="d_i-b">
    ...
    <li class="btn-personal-area">
        <a href="{site_url('/shop/profile')}">
            <span class="icon_enter"></span>
            <span class="text-el mq-inline-block mq-w-960 mq-max">{lang('Личный кабинет','newLevel')}</span><span class="text-el mq-inline-block mq-w-959 mq-min">{lang('Профиль','newLevel')}</span>
        </a>
    </li>
