<div class="frame-inside page-cart pageCart">
    <div class="container">
        ...
        <div class="js-no-empty no-empty">
            <div class="f-s_0 title-cart without-crumbs">
                <div class="frame-title">
                    <h1 class="title d_i">{lang('Оформление заказа','newLevel')}</h1>
                    {if !$is_logged_in}
                    <span class="old-buyer">
                        <button type="button" data-trigger="#loginButton">
                            <span class="text-el red">{lang('Я уже здесь покупал','newLevel')}</span>
                        </button>
                    </span>
                    {/if}
                </div>
            ...
            <form method="post" action="{$BASE_URL}shop/order/make_order" class="clearfix">
                <div class="right-cart">
                    <div class="frame-bask frame-bask-order">
                        <div class="frame-title clearfix">
                            ...
                            <div class="f_r">
                                <button type="button" class="a_g editCart">{lang('Редактировать', 'newLevel')}</button>
                            </div>
                        </div>
                ...
                <div class="left-cart">
                    <div class="horizontal-form order-form big-title">
                        ...
                        {/if}
                        <div class="groups-form">
                          <div class="title-order"><span class="icon-order1"></span><span class="d_i-b v-a_m">{lang('Личные данные','newLevel')}</span></div>
                          <label>
                        ...
                        <div class="frame-label">
                            ...
                            <div class="frame-form-field">
                                ...
                                <span class="f_r l-h_29">
                                    <button type="button" class="a_g m-l_10" data-drop=".drop-add-phone" data-overlay-opacity="0" data-place="inherit">{lang('Еще один номер', 'newLevel')}</button>
                                </span>
                                {/if}
                        ...
                        <label>
                            <span class="title">{lang('Электронный адрес','newLevel')}</span>
                            <span class="frame-form-field">
                    ...
                    <div class="groups-form">
                        ...
                        <div class="title-order"><span class="icon-order2"></span><span class="d_i-b v-a_m">{lang('Доставка','newLevel')}</span></div>
            ...
            <div class="frame-label">
                <div class="frame-form-field">
                    <button type="button" class="m-b_5 t-a_l" data-drop=".hidden-comment" data-place="inherit" data-overlay-opacity="0"><span class="a_g">{lang('Добавить комментарий к заказу', 'newLevel')}</span></button>
            ...
            <div class="frame-payment p_r">
                <div class="title-order"><span class="icon-order3"></span> <span class="d_i-b v-a_m">{lang('Способ оплаты','newLevel')}</span></div>
        ...
        <div class="groups-form">
            <div class="frame-label but-block t-a_c">


                    <div class="btn-buy btn-order">
