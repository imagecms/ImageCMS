                        ...
                        <table class="table-order table-order-view">
                                        ...
                                        <td class="frame-items">
                                            ...
                                            <div class="description">
                                                <span class="frame-variant-name-code">
                                                    {if trim(ShopCore::encode($orderProduct->variant_name) != '')}<span class="code js-code с_6">{echo ShopCore::encode($orderProduct->variant_name)}</span>{/if}
                                                    {if trim(ShopCore::encode($Variant->getNumber()) != '')}<span class="frame-variant-code frameVariantCode">{lang("Код",'newLevel')}: <span class="code js-code">{echo ShopCore::encode($Variant->getNumber())}</span></span>{/if}
                                                </span>
                                                {/*}
                            ...
                            <tfoot class="gen-info-price">
                                ...
                                {if $discount}
                                    <tr>
                                        <td colspan="3">
                                            <span class="c_6 f_l">{lang('Начальная стоимость товаров','newLevel')}</span>
                                            <div class="f_r">
                                                <span class="price-new">
                                                    <span>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <span class="c_6 f_l">{lang('Cтоимость товаров','newLevel')}</span>
                                        <div class="f_r">
                                            <span class="price-new">
                                                <span>
                                ...
                                {if $deliveryMethod}
                                    <tr>
                                        <td colspan="3">
                                            <span class="c_6 f_l">{lang('Доставка','newLevel')}</span>
                                            <div class="f_r">
                                                {if !$deliveryMethod->getDeliverySumSpecified()}
                                                    ...
                                                    {if $cartPrice < $priceDelFreeFrom}
                                                        ...
                                                        {/*}
                                                        {if $NextCSId}
                                                            (<span class="price">{echo $priceDelAdd}</span>
                                                            <span class="curr-add">{$NextCS}</span>)
                                                        {/if}
                                                       { */}
                                                    {else:}
                                ...
                                {if $discount}
                                    <tr>
                                        <td colspan="3">
                                            <span class="c_6 f_l">{lang('Ваша текущая скидка','newLevel')}</span>
                                ...
                                {if $model->getGiftCertPrice() > 0}
                                    <tr>
                                        <td colspan="3">
                                            <span class="c_6">{lang('Подарочный сертификат','newLevel')}</span>
                                            <span class="price-item f_r">
                ...
                <div class="footer-bask">
                    <div class="inside-padd">
                        ...
                        <div class="gen-sum-order clearfix">
                            ...
                            <span class="frame-prices f-s_0 f_r m-t_7">
                                <span class="current-prices f-s_0">
                                    <span class="price-new f-w_b">
                                        <span>
                                            <span class="price f-s_18">{echo $cartPrice}</span>
