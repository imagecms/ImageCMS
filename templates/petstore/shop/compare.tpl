            ...
            <div class="no-empty js-no-empty">
                ...
                <div class="f-s_0 title-compare without-crumbs clearfix">
                    <div class="frame-title">
                        <h1 class="title f-s_24">{lang('Список сравнения','newLevel')}</h1>
                    </div>
                </div>
                ...
                <div class="p_r">
                                    ...
                                    <div class="content-carousel">
                                        <ul class="items items-compare" id="items-catalog-main">
                                            ...
                                            <li class="compare_product_{echo $p->getId()}">
                                                ...
                                                <ul class="items items-catalog items-product  items-h-carousel">
                    ...
                    <div class="comprasion-head">
                        ...
                        { */}
                        <form>
                            <div class="title">{lang('сравнивать','newLevel')}</div>
                            <ul class="tabs-compare-diferent tabs">
                                <li class="frame-label">
                                    <button type="button" data-href="#all-params">
                                        <span class="niceRadio b_n">
                                            <input type="radio" name="compare2" checked="checked">
                                        </span>
                                        <span class="text-el c_6">{lang('Все параметры','newLevel')}</span>
                                    </button>
                                </li>
                                <li class="frame-label">
                                    <button type="button" data-href="#only-dif">
                                        <span class="niceRadio b_n">
                                            <input type="radio" name="compare2">
                                        </span>
                                        <span class="text-el c_6">{lang('Только Различия','newLevel')}</span>
                                    </button>
                                </li>
                            </ul>
                        </form>
