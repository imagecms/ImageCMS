...
<div class="comments" id="comments">
    <div class="title-comment">{if $comments_arr}{lang('Отзывы покупателей', 'newLevelVertical')}{/if} {if !$visibleMainForm || $visibleMainForm == NULL}<button class="d_l_1" data-drop=".comments-main-form" data-place="inherit" data-overlay-opacity="0" data-after="Comments.toComment">{lang('Оставить свой отзыв', 'newLevelVertical')}</button>{/if}</div>
    {if $comments_arr}
                    ...
                    <div class="inside-padd">
                        <form method="post">
                                ...
                                {if $use_moderation}
                                    <label class="d_n succ">
                                        <span class="frame-form-field">
                                            <div class="msg">
                                                <div class="success">
                                                    {lang('Комментарий будет отправлен на модерацию','newLevelVertical')}
                                                </div>
                                            </div>
                                        </span>
                                    </label>
                            ...
                            <div class="frame-label">
                                <span class="frame-form-field">
                                    <div class="btn-form">
                                        <input type="submit" value="{lang('Комментировать', 'newLevelVertical')}" onclick="Comments.post(this, {literal}{'visibleMainForm': '1'}{/literal})"/>
                                    </div>
                                </span>
                            </div>
                        </form>
                ...
                <form>
                    ...
                    <div class="frame-label">
                        <span class="frame-form-field">
                            ...
                            <span class="btn-form">
                                <input type="submit" value="{lang('Комментировать', 'newLevelVertical')}" onclick="Comments.post(this)"/>
                            </span>
                        </span>
                    </div>
                </form>
