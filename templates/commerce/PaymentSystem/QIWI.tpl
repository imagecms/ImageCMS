	...
	<form action="http://w.qiwi.ru/setInetBill.do" method="get" accept-charset="windows-1251" onSubmit="return checkSubmit();">
		...
		<table style="border-collapse:collapse;">
			<tr style="background:#f1f5fa;">
				<td style="color:#a3b52d; width:45%; text-align:center; padding:10px 0px;">Мобильный телефон</td>
			...
			<tr>
				...
				<td style="padding:10px">
					<input type="text" name="amount_rub" value="{$out_summ[0]}" maxlength="5" style="width:50px; text-align:right;  border: 1px inset #555;" /> руб. 
					<input type="text" name="amount_kop" value="{$out_summ[1]}" maxlength="2" size="2" style="text-align:right; border: 1px inset #555;"/> коп.
				</td>
			</tr>
			<tr style="background:#f1f5fa;">
