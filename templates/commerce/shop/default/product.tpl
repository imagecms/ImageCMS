                    ...
                    <div class="f_l">
                        ...
                        <span>
                            {if !is_in_wish($model->getId())}
                                <a data-varid="{echo $model->firstVariant->getId()}" data-prodid="{echo $model->getId()}"  data-logged_in="{if ShopCore::$ci->dx_auth->is_logged_in()===true}true{/if}"  href="#" class="js gray addToWList">Сохранить в список желаний</a>
                            {else:}
