    ...
    <div class="center">
        ...
        {if $items}
            ...
            {if ShopCore::$ci->dx_auth->is_logged_in()===true}
                <a href="#" class="f_l w-s_n-w" id="button_email">{lang("Send to a friend WishList")}</a>
                    ...
                    <tr>
                        <td colspan="6">
                            <div class="foot_cleaner">
                                ...
                                <div class="f_r sum">{lang("Total")}:</div>
                            </div>
                        </td>
                    </tr>
                </tfoot>
