...
{if $inCart}
    <div class="fancy wish_list">
        <form method="post" action="{shop_url('cart')}" >
            <h1 class="m-l_19">{lang("Basket")}</h1>
                        ...
                        <td colspan="6">
                            <div class="foot_cleaner">
                                ...
                                <div class="f_r buttons button_big_blue">
                                    <a href="{shop_url('cart')}">{lang("Formulation order")}</a>
                                </div>
                                <div class="f_r">
                                    {if $NextCS == $CS}
...
{else:}
    {literal}
        {"close":"true","msg": "<div class='fancy wish_list'><h1 class='m-l_19'>{/literal}{lang("Basket")}</h1><div class='comparison_slider'><div class='f-s_18  t-a_c' style='padding:53px 0;'>{lang("Basket empty")}{literal}</div></div></div>"}{/literal}
        {/if}