...
<ul>
            ...
            <li><a href="{site_url('shop/category/turizm-i-otdyh/tovary-dlia-otdyha')}">Товары для отдыха</a>
                <ul>
                    ...
                    <li><a href="{site_url('shop/category/turizm-i-otdyh/tovary-dlia-otdyha/naduvnye-izdeliia')}">Надувные изделия</a>
                        <ul>
                            <li><a href="{site_url('shop/category/turizm-i-otdyh/tovary-dlia-otdyha/naduvnye-izdeliia/krugi-narukavniki')}">Жилеты, круги, нарукавники</a></li>
                    ...
                    <!--
                    <li><a href="{site_url('shop/category/turizm-i-otdyh/tovary-dlia-otdyha/rolikovye-izdeliia')}">Ролики, доски, аксессуары</a>
                        <ul>
                            <li><a href="{site_url('shop/category/turizm-i-otdyh/tovary-dlia-otdyha/rolikovye-izdeliia/konki-rolikovye')}">Коньки роликовые</a></li>
                            <li><a href="{site_url('shop/category/turizm-i-otdyh/tovary-dlia-otdyha/rolikovye-izdeliia/skeitbordy')}">Скейтборды</a></li>
                            <li><a href="{site_url('shop/category/turizm-i-otdyh/tovary-dlia-otdyha/rolikovye-izdeliia/aksessuary')}">Аксессуары</a></li>
                        </ul>
                    </li>
                    -->
                    <li><a href="{site_url('shop/category/turizm-i-otdyh/tovary-dlia-otdyha/rolikovye-izdeliia/skeitbordy')}">Скейтборды</a></li>
    ...
    <li class="m_m_3"><a href="{site_url('shop/category/plavanie-i-daiving')}">Плавание и дайвинг</a>
        <ul>
            <li>
                <a href="{site_url('shop/category/plavanie-i-daiving/akvafitnes')}">Аквафитнес</a>
        ...
        <ul>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{site_url('shop/category/raketochnye-vidy-sporta/tennis/aksessuary')}">Аксессуары</a></li>
                </ul>
            </li>
        </ul>
    </li>
    ...
    <li class="m_m_9"><a href="{site_url('shop/category/hudozhestvennaia-gimnastika')}">Художественная гимнастика</a>
        <ul>
            <li>
                ...
                <a href="{site_url('shop/category/hudozhestvennaia-gimnastika/obruchi')}">Обручи</a>
