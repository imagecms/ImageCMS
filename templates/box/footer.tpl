    ...
    <div class="container">
        ...
        <div class="box-1">
            <div class="inside-padd">
                ...
                <div class="text-el">{lang('Все права защищены','box')}</div>
                {echo $CI->load->module('share')->_make_share_form()}
            </div>
        </div>
        <div class="box-2">
            <div class="inside-padd">
                <div class="main-title">{lang('Каталог','box')}</div>
        ...
        <div class="box-3">
            <div class="inside-padd">
                <div class="main-title">{lang('Информация','box')}</div>
        ...
        <div class="box-4">
            <div class="inside-padd">
                <div class="main-title">{lang('Контакты','box')}</div>
                <ul>
                    <li>
