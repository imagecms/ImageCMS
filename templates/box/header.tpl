                ...
                <div class="phones-header">
                    ...
                    <div class="btn-order-call v-a_b">
                        <button data-href="#ordercall" data-drop="#ordercall" data-tab="true" data-source="{site_url('shop/callback')}">
                            ...
                            <span class="text-el ref-2">{lang('Заказать звонок','box')}</span>
                        </button>
                    </div>
                </div>
                <!--End. Contacts block-->
                    ...
                    <div class="p_r">
                        <form name="search" method="get" action="{shop_url('search')}">
                            <span class="btn-search">
                                <button type="submit"><span class="text-el">{lang('Поиск','box')}</span></button>
                            </span>
                            <div class="frame-search-input">
                                <span class="icon_search"></span>
                                <input type="text" class="input-search" id="inputString" name="text" autocomplete="off" value="{if strpos($CI->uri->uri_string, 'search') !== false}{htmlspecialchars($_GET['text'])}{/if}"  placeholder="{lang('Я ищу', 'box')}"/>
