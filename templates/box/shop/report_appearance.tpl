<div class="drop drop-report drop-style">
    ...
    <div class="drop-header">
        <div class="title">{lang('Сообщить о появлении','box')}</div>
    </div>
            ...
            <div class="horizontal-form">
                ...
                <label>
                    ...
                    <span class="frame-form-field">
                        ...
                        <span class="must">*</span>
                        <span class="help-block">{lang('Вы получите письмо, когда товар будет доступен','box')}</span>
                    </span>
                </label>
                <label>
                ...
                <label>
                    <span class="title">{lang('Текст','box')}</span>
