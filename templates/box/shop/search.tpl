            ...
            {if $totalProducts != 0}
                <div class="f-s_0 title-category">
                    <div class="frame-title">
                        <h1 class="title"><span class="s-t">{lang('Результаты поиска','box')}</span> <span class="what-search">«{encode($_GET['text'])}»</span></h1>
                    </div>
                <span class="count">({lang('Найдено','box')} {$totalProducts} {echo SStringHelper::Pluralize($totalProducts, array(lang('товар','box'),lang('товара','box'),lang('товаров','box')))})</span>
                </div>
            {/if}
            {if $totalProducts == 0}
                <div class="msg layout-highlight layout-highlight-msg">
                    <div class="info">
                        ...
                        <span class="text-el">{lang('Не найдено товаров','box')}</span>
                    </div>
                </div>
            {/if}
                ...
                <div class="frame-category-menu layout-highlight">
                    <div class="title-menu-category">
                        <div class="title-default">
                            <div class="title-h3 title">{lang('Категории','box')}</div>
                        </div>
                    </div>
