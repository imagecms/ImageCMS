    ...
    <div class="container">
        <div class="f-s_0 title-login without-crumbs">
            <div class="frame-title">
                <h1 class="title">{lang('Вход','box')}</h1>
            </div>
        </div>
        <div class="horizontal-form frame-register">
            <form method="post" id="login_form_main" onsubmit="ImageCMSApi.formAction('{site_url("/auth/authapi/login")}', '#login_form_main');
                    ...
                    <div class="frame-form-field">
                        <div class="clearfix">
                            ...
                            <div class="f_r neigh-buttonform">
                                ...
                                <button type="button" class="d_l_1" data-drop=".drop-forgot" data-source="{site_url('auth/forgot_password')}">{lang('Забыли Пароль?','box')}</button>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="frame-label">
                    <span class="title">&nbsp;</span>
                    <div class="frame-form-field">
                        <div class="help-block">{lang('Я еще не зарегистрирован','box')}</div>
                        <a href="/auth/register">{lang('Перейти к регистрации','box')}</a>
                    </div>
                </div>
                {form_csrf()}
            </form>
