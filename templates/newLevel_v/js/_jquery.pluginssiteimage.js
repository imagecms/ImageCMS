...
(function($) {
    methods = {
        init: function(options) {
            ...
            var tooltip = $('.tooltip').not('.cloned-actual');
...
(function($) {
    ...
    $.fn.menuPacket2 = function(method) {
        if (methods[method]) {
            ...
            $.error('Method ' + method + ' does not exist on jQuery.menuPacket2');
        }
    };
})(jQuery);
(function($) {
    ...
    $.fn.actual = function() {
        ...
        if (arguments.length && typeof arguments[0] == 'string') {
            ...
            var clone = $(this).clone().css({
                ...
                top: '-9999px',
                display: 'block'
            }).addClass('cloned-actual').appendTo('body');
            return clone[dim]();
        }
        ;
        return undefined;
...
(function($) {
    var methods = {
        init: function(options) {
            ...
            selectorPosition = -1;
            inputString = settings.inputString.keyup(function(e) {
                var code = e.keyCode;
                if (code != 27) {
                    methods.lookup(e);
                }
