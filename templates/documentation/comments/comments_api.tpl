    ...
    <ul class="frame-list-comment__icsi-css">
        ...
        <li>
            ...
            <ul class="answear-programmer">
                <li>
                    <div class="title">Ответ от разработчика ImageCMS Марко</div>
                    <p>Вам достаточно только назвать стратегические категории товаров или услуг, после чего наши специалисты сформируют для вас соответствующее коммерческое предложение. Вы сможете утвердить его или подкорректировать.Вам достаточно только назвать стратегические категории товаров или услуг, после чего наши специалисты сформируют для вас соответствующее коммерческое предложение. Вы сможете утвердить его или подкорректировать.Вам достаточно только назвать стратегические категории товаров или услуг, после чего наши специалисты сформируют для вас соответствующее коммерческое предложение. Вы сможете утвердить его или подкорректировать.</p>
                </li>
            </ul>
            {/*}  <ul class="frame-list-comment__icsi-css">
...
<div class="main-form-comments__icsi-css">
    <div class="frame-comments__icsi-css">
        <div class="inside-padd">
            <div class="title_h2__icsi-css">{lang('У вас возник вопрос? Пишите', 'comments')}</div>
            ...
            <div class="form-comment__icsi-css form__icsi-css horizontal-form">
                <div class="inside-padd">
                    <form method="post">
                        ...
                        <label>
                            <span class="title__icsi-css">{lang('Описание проекта', 'comments')}<span class="must">*</span></span>
                            <span class="frame_form_field__icsi-css">
