<div class="clearfix">
    <input type="text" id="prorerties_filter" style="width: 300px;" placeholder="{lang('Start typing property name here','boxVertical')}">
    ...
    <table class="table table-striped table-bordered table-hover table-condensed">
        <thead>
            <tr>
                ...
                <th class="span5">
                    {lang('Name', 'boxVertical')}
                </th>
                <th class="span5">
                    {lang('Type', 'boxVertical')}
                </th>                               
            </tr>
        </thead>
        <tbody>
