        ...
        {else:}
            <li class="btn-personal-exit">
                ...
                <ul class="drop dropPersonalExit drop-auth-refer drop-noinherit">
                    <li><a href="{site_url('/shop/profile/#my_data')}">{lang('Основные данные', 'boxVertical')}</a></li>
                    <li><a href="{site_url('/shop/profile/#change_pass')}">{lang('Изменить пароль', 'boxVertical')}</a></li>
                    <li><a href="{site_url('/shop/profile/#history_order')}">{lang('История заказа', 'boxVertical')}</a></li>
