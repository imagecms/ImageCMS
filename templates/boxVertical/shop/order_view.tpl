    ...
    <div class="container">
        {if $CI->session->flashdata('makeOrder') === true}
            <div class="f-s_0 without-crumbs">
                <div class="frame-title">
                    <h1 class="title">{lang('Спасибо, ваш заказ принят!', 'boxVertical')}<br/>{lang('Наши менеджеры свяжутся с вами.','boxVertical')}</h1>
                </div>
            </div>
        {/if}
        <div class="f-s_0 title-order-view without-crumbs">
            <div class="frame-title">
                <h1 class="title">{lang('Заказ №','boxVertical')}:<span class="number-order">{echo $model->getId()}</span></h1>
            </div>
        </div>
        ...
        <div class="left-order">
            ...
            <table class="table-info-order">
                ...
                <tr>
                    <th>{lang('Имя получателя','boxVertical')}:</th>
                    <td>{echo $model->getUserFullName()}</td>
                </tr>
                {if $model->getUserPhone()}
                    <tr>
                        <th>{lang('Телефон','boxVertical')}:</th>
                ...
                {if $s_field.field_data && $s_field.field_data !== ''}
                    <tr>
                        <th>{lang('Дополнительный телефон','boxVertical')}:</th>
                ...
                {if $model->getDeliveryMethod()}
                    ...
                    <tr>
                        <th>{lang('Способ доставки','boxVertical')}:</th>
                        <td>
                ...
                {if $s_field.field_data && $s_field.field_data !== ''}
                    <tr>
                        <th>{lang('Город','boxVertical')}:</th>
                        <td>{echo $s_field.field_data}</td>
                    </tr>
                {/if}
                {if $model->getUserDeliverTo()}
                    <tr>
                        <th>{lang('Адрес','boxVertical')}:</th>
                        <td>{echo $model->getUserDeliverTo()}</td>
                    </tr>
                {/if}
                {if $model->getUserComment()}
                    <tr>
                        <th>{lang('Комментарий','boxVertical')}:</th>
                ...
                <tr>
                    <th>{lang('Дата заказа','boxVertical')}:</th>
                ...
                {if $paymentMethod}
                    <tr>
                        <th>{lang('Способ оплаты','boxVertical')}:</th>
                        <td>
                ...
                <!--                Start. Order status-->
                <tr>
                    <th>{lang('Статус оплаты','boxVertical')}:</th>
                    <td>
                        {if $model->getPaid() == true}
                            <span class="status-pay paid">{lang('Оплачен','boxVertical')}</span>
                        {else:}
                            <span class="status-pay not-paid">{lang('Не оплачен','boxVertical')}</span>
                        {/if}
                    </td>
                </tr>
                <!--                End. Order status-->
                        ...
                        <table class="table-order table-order-view">
                                ...
                                {foreach $model->getOrderProducts() as $orderProduct}
                                    ...
                                    <tr class="items items-bask items-order cart-product">
                                        <td class="frame-items">
                                            ...
                                            <div class="description">
                                                <span class="frame-variant-name-code">
                                                    {if trim(ShopCore::encode($orderProduct->variant_name) != '')}<span class="frame-variant-name frameVariantName">{lang("Вариант",'boxVertical')}: <span class="code js-code">{echo ShopCore::encode($orderProduct->variant_name)}</span></span>{/if}
                                                    {if trim(ShopCore::encode($Variant->getNumber()) != '')}<span class="frame-variant-code frameVariantCode">{lang("Артикул",'boxVertical')}: <span class="code js-code">{echo ShopCore::encode($Variant->getNumber())}</span></span>{/if}
                                                </span>
                                                {/*}
                                        ...
                                        <td>
                                            ...
                                            <span class="text-el">{lang('шт','boxVertical')}.</span>
                                        </td>
                                ...
                                {foreach $model->getOrderKits() as $orderProduct}
                                    <tr class="row-kits rowKits items-order row">
                                        <td class="frame-items frame-items-kit">
                                            <div class="title">{lang('Комплект товаров', 'boxVertical')}</div>
                            ...
                            <tfoot class="gen-info-price">
                                ...
                                {if $discount}
                                    <tr>
                                        <td colspan="3">
                                            <span class="s-t f_l">{lang('Начальная стоимость товаров','boxVertical')}</span>
                                            <div class="f_r">
                                                <span class="price-new">
                                                    <span>
                                ...
                                <tr>
                                    <td colspan="3">
                                        <span class="s-t f_l">{lang('Cтоимость товаров','boxVertical')}</span>
                                ...
                                {if $deliveryMethod}
                                    <tr>
                                        <td colspan="3">
                                            <span class="s-t f_l">{lang('Доставка','boxVertical')}:</span>
                                            <div class="f_r">
                                                {if !$deliveryMethod->getDeliverySumSpecified()}
                                                    ...
                                                    {if $cartPrice < $priceDelFreeFrom}
                                                        ...
                                                        {/if}
                                                    {else:}
                                                        <span class="text-el s-t">{lang('Бесплатно', 'boxVertical')}</span>
                                                    {/if}
                                                {else:}
                                ...
                                {if $discount}
                                    <tr>
                                        <td colspan="3">
                                            <span class="s-t f_l">{lang('Ваша текущая скидка','boxVertical')}:</span>
                                ...
                                {if $model->getGiftCertPrice() > 0}
                                    <tr>
                                        <td colspan="3">
                                            <span class="s-t">{lang('Подарочный сертификат','boxVertical')}:</span>
                                            <span class="price-item f_r">
                ...
                <div class="footer-bask">
                    <div class="inside-padd">
                        ...
                        <div class="gen-sum-order clearfix">
                            <span class="title f_l">{lang('Всего к оплате','boxVertical')}:</span>
