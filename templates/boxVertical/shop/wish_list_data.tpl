...
<div class="drop drop-info drop-info-wishlist">
    ...
    <span class="text-el">
        ...
        “{lang('Список желаний', 'boxVertical')}” {lang('пуст', 'boxVertical')}</span>
</div>