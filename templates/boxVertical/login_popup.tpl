                        ...
                        <div class="frame-form-field">
                            <div class="clearfix">
                                ...
                                <div class="f_l neigh-buttonform f-s_0">
                                    ...
                                    <button type="button" class="d_l_3" data-drop=".drop-forgot" data-source="{site_url('auth/forgot_password')}">{lang('Напомнить пароль','boxVertical')}</button>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="inside-padd">
                            <div class="horizontal-form">
                                <div class="frame-label">
                                    <span class="title">&nbsp;</span>
                                    <div class="frame-form-field">
                                        <div class="help-block">{lang('Для новых покупателей нашего магазина','boxVertical')}:</div>
                                        <a href="/auth/register">{lang('Регистрация','boxVertical')}</a>
                                    </div>
                                </div>
                            </div>
                        </div>
